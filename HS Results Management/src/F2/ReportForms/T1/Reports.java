package F2.ReportForms.T1;

import F2.ReportForms.T1.PrintPass;
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            * */
               ...
               /* Get instance of CategoryPlot */
                ...
                document.close();
            writer.close();
            infoBox("Document containing average results for " +NAME + " has been generated open it for printing.","Done",null);
