...
import F2.ReportForms.T3.PrintPass;
...
public class AllSubjects implements Initializable{
    ...
    private void setMarks(){
        String sqlEx1 = "SELECT * FROM tbl_f2_t3_ex1 WHERE class='FORM_1' AND adm=?";
        String sqlEx2 ="SELECT * FROM tbl_f2_t3_ex2 WHERE class='FORM_1' AND adm=?";
        String sqlEx3 ="SELECT * FROM tbl_f2_t3_ex3 WHERE class='FORM_1' AND adm=?";
        String sqlAvg ="SELECT * FROM tbl_f2_t3_avg WHERE class='FORM_1' AND adm=?";
        ...
        try{
            ...
            /***CRE***/
            creEx1.setText(setEx1.getString(24));
            creEx2.setText(setEx2.getString(24));
            creEx3.setText(setEx3.getString(24));
            creAvg.setText(setAvg.getString(24));
            creEx1Grade.setText(setEx1.getString(25));
            creEx2Grade.setText(setEx2.getString(25));
            creEx3Grade.setText(setEx3.getString(25));
            creAvgGrade.setText(setAvg.getString(25));
            ...
            avgEx1.setText(String.valueOf(Integer.parseInt(setEx1.getString(30))/11));
            avgEx2.setText(String.valueOf(Integer.parseInt(setEx2.getString(30))/11));
            avgEx3.setText(String.valueOf(Integer.parseInt(setEx3.getString(30))/11));
            avgAvg.setText(String.valueOf(Integer.parseInt(setAvg.getString(30))/11));
