...
public class AllSubjects implements Initializable{
    ...
    private void setMarks(){
        String sqlEx1 = "SELECT * FROM tbl_f2_t2_ex1 WHERE class='FORM_1' AND adm=?";
        String sqlEx2 ="SELECT * FROM tbl_f2_t2_ex2 WHERE class='FORM_1' AND adm=?";
        String sqlEx3 ="SELECT * FROM tbl_f2_t2_ex3 WHERE class='FORM_1' AND adm=?";
        String sqlAvg ="SELECT * FROM tbl_f2_t2_avg WHERE class='FORM_1' AND adm=?";
