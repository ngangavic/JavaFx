...
//String POS,
    public resultsData(String ADM,String NAME,String ENG,String ENGG,String KIS,String KISG,String MAT,String MATG,String BIO,String BIOG,String CHEM,String CHEMG,String PHY,String PHYG,String GEO,String GEOG,String HIS,String HISG,String CRE,String CREG,String BUS,String BUSG,String AGRI,String AGRIG,String KCPE){
        ...
        //float eng1,kis1,math1,bio1,chem1,phy1,geo1,his1,cre1,bus1,agri1;
        float eng1,kis1,math1,bio1,chem1,phy1,geo1,his1,cre1,bus1,agri1;
        eng1=Float.parseFloat(ENG);
        kis1=Float.parseFloat(KIS);
        math1=Float.parseFloat(MAT);
        bio1=Float.parseFloat(BIO);
        chem1=Float.parseFloat(CHEM);
        phy1=Float.parseFloat(PHY);
        geo1=Float.parseFloat(GEO);
        his1=Float.parseFloat(HIS);
        cre1=Float.parseFloat(CRE);
        bus1=Float.parseFloat(BUS);
        agri1=Float.parseFloat(AGRI);

        /*eng1=Integer.parseInt(ENG);
        kis1=Integer.parseInt(KIS);
        math1=Integer.parseInt(MAT);
        bio1=Integer.parseInt(BIO);
        chem1=Integer.parseInt(CHEM);
        phy1=Float.parseFloat(PHY);
        geo1=Integer.parseInt(GEO);
        his1=Integer.parseInt(HIS);
        cre1=Integer.parseInt(CRE);
        bus1=Integer.parseInt(BUS);
        agri1=Integer.parseInt(AGRI);*/
        /*eng1= ENG;
        kis1=KIS;
        math1=MAT;
        bio1=BIO;
        ...
        bus1=BUS;
        agri1=AGRI;*/
        float add = eng1+kis1+math1+bio1+chem1+phy1+geo1+his1+cre1+bus1+agri1;
        /*float add=(Integer.parseInt(eng1)+
        Integer.parseInt(kis1)+
        Integer.parseInt(math1)+
        Integer.parseInt(bio1)+
        Float.parseFloat(chem1)+
        Integer.parseInt(phy1)+
        Integer.parseInt(geo1)+
        Integer.parseInt(his1)+
        Integer.parseInt(cre1)+
        Integer.parseInt(bus1)+
        Integer.parseInt(agri1));*/
        float avg = Math.round((add/11));

        this.total = new SimpleStringProperty(String.valueOf(add));
        this.avg = new SimpleStringProperty(String.valueOf(avg));
        try {
            String sql = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='TOTAL'";
