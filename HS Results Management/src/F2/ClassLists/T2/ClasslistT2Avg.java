package F2.ClassLists.T2;

import F2.ClassLists.T2.Printpass;
import F2.ClassLists.T2.resultsData;
import F2.ReportForms.T2.*;
...
public class ClasslistT2Avg implements Initializable{
    String cname = System.getProperty("user.home");
    Calendar now = Calendar.getInstance();
    @FXML
    private TableView<F2.ClassLists.T2.resultsData> tableAllResults;
    @FXML private TableColumn<F2.ClassLists.T2.resultsData,String> positionColumn,admColumn,nameColumn,totalColumn,avgColumn,gradeColumn,kcpeColumn;
    @FXML private TableColumn<F2.ClassLists.T2.resultsData,String>engColumn,kisColumn, matColumn,bioColumn,chemColumn,phyColumn,geoColumn,hisColumn,creColumn,busColumn,agriColumn;
    @FXML private TableColumn<F2.ClassLists.T2.resultsData,String>engGrade,kisGrade,matGrade,bioGrade,chemGrade,phyGrade,geoGrade,hisGrade,creGrade,busGrade,agriGrade;
    private ObservableList<F2.ClassLists.T2.resultsData> tableList;
    public static String printPassword;

    public void showData(){
        String sql="SELECT * FROM tbl_f2_t2_avg WHERE class = 'FORM_1' ORDER BY total DESC ";
...
connection.close();
    ...
    private void openAllSubjects(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/allSubjects.fxml"));
    ...
    private void openPhyHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/PhyHisBus.fxml"));
    ...
    private void openPhyHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/PhyHisAgri.fxml"));
    ...
    private void openPhyGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/PhyGeoBus.fxml"));
    ...
    private void openPhyGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/PhyGeoAgri.fxml"));
    ...
    private void openPhyCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/PhyCreBus.fxml"));
    ...
    private void openPhyCreAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/PhyCreAgri2.fxml"));
    ...
    private void openBioHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/BioHisBus.fxml"));
    ...
    private void openBioHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/BioHisAgri.fxml"));
    ...
    private void openBioGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/BioGeoBus.fxml"));
    ...
    private void openBioGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/BioGeoAgri.fxml"));
    ...
    private void openBioCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/BioCreBus.fxml"));
    ...
    private void openBioCreAgri(String name){
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T2/BioCreAgri.fxml"));
    ...
    private void calcTotal(){
        String sqlDet = "SELECT * FROM tbl_f2_t2_avg WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f2_t2_avg SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f2_t2_avg SET grade=? WHERE adm=?";
...
connection.close();
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f2_t2_avg WHERE class = 'FORM_1' ORDER BY total DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(total) SUM_AVG FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f2_t2_avg WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F2T2AvgClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 2 TERM 2 AVERAGE", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing average results for FORM 2 TERM 2 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F2T2AvgClassResults.pdf"));
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
            }
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f2_t2_avg WHERE class = 'FORM_1' ORDER BY total DESC ";
        ...
        try{
            ...
            String names = "Form2_term2_average";
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx1 = "SELECT * FROM tbl_f2_t2_ex1 WHERE adm=? ";
            String sqlEx2 = "SELECT * FROM tbl_f2_t2_ex2 WHERE adm=? ";
            String sqlEx3 = "SELECT * FROM tbl_f2_t2_ex3 WHERE adm=? ";
            String sqlAvg = "SELECT * FROM tbl_f2_t2_avg WHERE adm=? ";
            ...
            try{
                ...
                PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+g));
            ...
            * */
               ...
               /* Get instance of CategoryPlot */
                ...
                dataSet.setValue(avgAvgTotal, "Marks", "F2T2");
    ...
    private void printAllSubjects(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+g,font));
