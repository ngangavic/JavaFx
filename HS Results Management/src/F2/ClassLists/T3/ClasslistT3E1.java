...
public class ClasslistT3E1 implements Initializable{
    ...
    public void showData(){
        String sql="SELECT * FROM tbl_f2_t3_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
    ...
    private void calcTotal(){
        String sqlDet = "SELECT * FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f2_t3_ex1 SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f2_t3_ex1 SET grade=? WHERE adm=?";
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f2_t3_ex1 WHERE class = 'FORM_1' ORDER BY total DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(total) SUM_AVG FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f2_t3_ex1 WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new
                        FileOutputStream("F2T3Exam1ClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 2 TERM 3 EXAM 1", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing exam 1 results for FORM 2 TERM 3 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F2T3Exam1ClassResults.pdf"));
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
            }
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f2_t3_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
        ...
        try{
            ...
            document.close();
            writer.close();
            infoBox("Document containing exam 1 results for form 1 term 3 has been created open it for printing.","Done",null);
...
connection.close();
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlF2T1E1 = "SELECT * FROM tbl_f2_t1_ex1 WHERE adm=?";
            String sqlF2T2E1 = "SELECT * FROM tbl_f2_t2_ex1 WHERE adm=?";
            ...
            try{
                ...
                PreparedStatement statementE1F1T1 = connection.prepareStatement(sqlF1T1Ex1);
                PreparedStatement statementE1F1T2 = connection.prepareStatement(sqlF1T2Ex1);
                PreparedStatement statementE1F1T3 = connection.prepareStatement(sqlF1T3Ex1);
                PreparedStatement statementE1F2T1 = connection.prepareStatement(sqlF2T1E1);
                PreparedStatement statementE1F2T2 = connection.prepareStatement(sqlF2T2E1);
                ...
                statementE1F1T3.setString(1,adm);
                statementE1F2T1.setString(1,adm);
                statementE1F2T2.setString(1,adm);


                ResultSet set = statement.executeQuery();
                ResultSet setE1 = statementE1.executeQuery();
                ResultSet setF1T1E1 = statementE1F1T1.executeQuery();
                ResultSet setF1T2E1 = statementE1F1T2.executeQuery();
                ResultSet setF1T3E1 = statementE1F1T3.executeQuery();
                ResultSet setF2T1E1 = statementE1F2T1.executeQuery();
                ResultSet setF2T2E1 = statementE1F2T2.executeQuery();
                ...
                if (avgKis >= Integer.parseInt(setKisGrade.getString(4))) {com = setComments.getString(2); } else if (avgKis >= Integer.parseInt(setKisGrade.getString(5))) { com = setComments.getString(3); }else if (avgKis >=Integer.parseInt(setKisGrade.getString(6))){ com = setComments.getString(4);}else if (avgKis >=Integer.parseInt(setKisGrade.getString(7))){
                    ...
                    com = setComments.getString(12);}else {com = setComments.getString(13); }
                PdfPCell kisD5 = new PdfPCell(new Paragraph(setE1.getString(10)+" "+setE1.getString(11)));
                ...
                PdfPCell matD5 = new PdfPCell(new Paragraph(setE1.getString(12)+" "+setE1.getString(13)));
                ...
                PdfPCell chemD5 = new PdfPCell(new Paragraph(setE1.getString(14)+" "+setE1.getString(15)));
                ...
                PdfPCell bioD5 = new PdfPCell(new Paragraph(setE1.getString(16)+" "+setE1.getString(17)));
                ...
                int avgCre = Integer.parseInt(setE1.getString(24));
                ...
                PdfPCell creD5 = new PdfPCell(new Paragraph(setE1.getString(24)+" "+setE1.getString(25)));
                ...
                PdfPCell agriD5 = new PdfPCell(new Paragraph(setE1.getString(28)+" "+setE1.getString(29)));
...
/* Get instance of CategoryPlot */
                ...
                dataSet.setValue((Integer.parseInt(setF1T1E1.getString(30))/11), "Marks", "F1T1");
                dataSet.setValue((Integer.parseInt(setF1T2E1.getString(30))/11), "Marks", "F1T2");
                dataSet.setValue((Integer.parseInt(setF1T3E1.getString(30))/11), "Marks", "F1T3");
                dataSet.setValue((Integer.parseInt(setF2T1E1.getString(30))/11), "Marks", "F2T1");
                dataSet.setValue((Integer.parseInt(setF2T2E1.getString(30))/11), "Marks", "F2T2");
    ...
    private void printBioCreBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell busD5 = new PdfPCell(new Paragraph(setE1.getString(26)+" "+setE1.getString(27)));
    ...
    private void printBioHisAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell hisD5 = new PdfPCell(new Paragraph(setE1.getString(22)+" "+setE1.getString(23)));
    ...
    private void printBioGeoAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell geoD5 = new PdfPCell(new Paragraph(setE1.getString(20)+" "+setE1.getString(21)));
    ...
    private void printPhyCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell phyD5 = new PdfPCell(new Paragraph(setE1.getString(18)+" "+setE1.getString(19)));
    ...
    private void printAllSubjects(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell creD5 = new PdfPCell(new Paragraph(setE1.getString(24)+" "+setE1.getString(25),font));
                ...
                //float avgAvgTotal = (addAvgEx1+addAvgEx2+addAvgEx3)/3;
                int avgAvgTotal=Integer.parseInt(setE1.getString(30))/11;
