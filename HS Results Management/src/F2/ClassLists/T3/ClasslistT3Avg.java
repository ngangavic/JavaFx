package F2.ClassLists.T3;

import F2.ClassLists.T3.Printpass;
import F2.ClassLists.T3.resultsData;
import F2.ReportForms.T3.*;
...
public class ClasslistT3Avg implements Initializable{
    ...
    @FXML
    private TableView<F2.ClassLists.T3.resultsData> tableAllResults;
    @FXML private TableColumn<F2.ClassLists.T3.resultsData,String> positionColumn,admColumn,nameColumn,totalColumn,avgColumn,gradeColumn,kcpeColumn;
    @FXML private TableColumn<F2.ClassLists.T3.resultsData,String>engColumn,kisColumn, matColumn,bioColumn,chemColumn,phyColumn,geoColumn,hisColumn,creColumn,busColumn,agriColumn;
    @FXML private TableColumn<F2.ClassLists.T3.resultsData,String>engGrade,kisGrade,matGrade,bioGrade,chemGrade,phyGrade,geoGrade,hisGrade,creGrade,busGrade,agriGrade;
    private ObservableList<F2.ClassLists.T3.resultsData> tableList;
    public static String printPassword;

    public void showData(){
        String sql="SELECT * FROM tbl_f2_t3_avg WHERE class = 'FORM_1' ORDER BY total DESC ";
...
connection.close();
    ...
    public void onStudentClick(){
       ...
       /*try{
            ...
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T1/allSubjects.fxml"));
    ...
    private void openAllSubjects(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/allSubjects.fxml"));
    ...
    private void openPhyHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/PhyHisBus.fxml"));
    ...
    private void openPhyHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/PhyHisAgri.fxml"));
    ...
    private void openPhyGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/PhyGeoBus.fxml"));
    ...
    private void openPhyGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/PhyGeoAgri.fxml"));
    ...
    private void openPhyCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/PhyCreBus.fxml"));
    ...
    private void openPhyCreAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/PhyCreAgri.fxml"));
    ...
    private void openBioHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/BioHisBus.fxml"));
    ...
    private void openBioHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/BioHisAgri.fxml"));
    ...
    private void openBioGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/BioGeoBus.fxml"));
    ...
    private void openBioGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/BioGeoAgri.fxml"));
    ...
    private void openBioCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/BioCreBus.fxml"));
    ...
    private void openBioCreAgri(String name){
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F2/ReportForms/T3/BioCreAgri.fxml"));
    ...
    private void calcTotal(){
        String sqlDet = "SELECT * FROM tbl_f2_t3_avg WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f2_t3_avg SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f2_t3_avg SET grade=? WHERE adm=?";
...
connection.close();
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f2_t3_avg WHERE class = 'FORM_1' ORDER BY total DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(total) SUM_AVG FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f2_t3_avg WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F2T3AvgClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 2 TERM 3 AVERAGE", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing average results for FORM 2 TERM 3 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F2T3AvgClassResults.pdf"));
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
            }
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f2_t3_avg WHERE class = 'FORM_1' ORDER BY total DESC ";
        ...
        try{
            ...
            String names = "Form2_term3_average";
            ...
            document.close();
            writer.close();
            infoBox("Document containing average results for form 1 term 3 has been created open it for printing.","Done",null);
...
connection.close();
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx1 = "SELECT * FROM tbl_f2_t3_ex1 WHERE adm=? ";
            String sqlEx2 = "SELECT * FROM tbl_f2_t3_ex2 WHERE adm=? ";
            String sqlEx3 = "SELECT * FROM tbl_f2_t3_ex3 WHERE adm=? ";
            String sqlAvg = "SELECT * FROM tbl_f2_t3_avg WHERE adm=? ";
            ...
            try{
                ...
                document.add((new Paragraph("ADM: "+set.getString(2)+"  "+"NAME: "+set.getString(3)+"   "+set.getString(4)+" "+set.getString(5)+"  "+"KCPE:"+set.getString(6)+"  "+"CLASS:FORM 2"+"  "+"TERM:TERM 1",new Font(Font.FontFamily.TIMES_ROMAN, 9,Font.BOLD))));
                ...
                PdfPCell kisD2 = new PdfPCell(new Paragraph(setE1.getString(10)+" "+setE1.getString(11)));
                PdfPCell kisD3 = new PdfPCell(new Paragraph(setE2.getString(10)+" "+setE2.getString(11)));
                PdfPCell kisD4 = new PdfPCell(new Paragraph(setE3.getString(10)+" "+setE3.getString(11)));
                ...
                if (avgKis >= Integer.parseInt(setKisGrade.getString(4))) {com = setComments.getString(2); } else if (avgKis >= Integer.parseInt(setKisGrade.getString(5))) { com = setComments.getString(3); }else if (avgKis >=Integer.parseInt(setKisGrade.getString(6))){ com = setComments.getString(4);}else if (avgKis >=Integer.parseInt(setKisGrade.getString(7))){
                    ...
                    com = setComments.getString(12);}else {com = setComments.getString(13); }
                PdfPCell kisD5 = new PdfPCell(new Paragraph(setAvg.getString(10)+" "+setAvg.getString(11)));
                ...
                PdfPCell matD2 = new PdfPCell(new Paragraph(setE1.getString(12)+" "+setE1.getString(13)));
                PdfPCell matD3 = new PdfPCell(new Paragraph(setE2.getString(12)+" "+setE2.getString(13)));
                PdfPCell matD4 = new PdfPCell(new Paragraph(setE3.getString(12)+" "+setE3.getString(13)));
                ...
                PdfPCell matD5 = new PdfPCell(new Paragraph(setAvg.getString(12)+" "+setAvg.getString(13)));
                ...
                PdfPCell chemD2 = new PdfPCell(new Paragraph(setE1.getString(14)+" "+setE1.getString(15)));
                PdfPCell chemD3 = new PdfPCell(new Paragraph(setE2.getString(14)+" "+setE2.getString(15)));
                PdfPCell chemD4 = new PdfPCell(new Paragraph(setE3.getString(14)+" "+setE3.getString(15)));
                ...
                PdfPCell chemD5 = new PdfPCell(new Paragraph(setAvg.getString(14)+" "+setAvg.getString(15)));
                ...
                PdfPCell bioD2 = new PdfPCell(new Paragraph(setE1.getString(16)+" "+setE1.getString(17)));
                PdfPCell bioD3 = new PdfPCell(new Paragraph(setE2.getString(16)+" "+setE2.getString(17)));
                PdfPCell bioD4 = new PdfPCell(new Paragraph(setE3.getString(16)+" "+setE3.getString(17)));
                ...
                PdfPCell bioD5 = new PdfPCell(new Paragraph(setAvg.getString(16)+" "+setAvg.getString(17)));
                ...
                PdfPCell creD2 = new PdfPCell(new Paragraph(setE1.getString(24)+" "+setE1.getString(25)));
                PdfPCell creD3 = new PdfPCell(new Paragraph(setE2.getString(24)+" "+setE2.getString(25)));
                PdfPCell creD4 = new PdfPCell(new Paragraph(setE3.getString(24)+" "+setE3.getString(25)));

                int avgCre = Integer.parseInt(setAvg.getString(24));
                ...
                PdfPCell creD5 = new PdfPCell(new Paragraph(setAvg.getString(24)+" "+setAvg.getString(25)));
                ...
                PdfPCell agriD2 = new PdfPCell(new Paragraph(setE1.getString(28)+" "+setE1.getString(29)));
                PdfPCell agriD3 = new PdfPCell(new Paragraph(setE2.getString(28)+" "+setE2.getString(29)));
                PdfPCell agriD4 = new PdfPCell(new Paragraph(setE3.getString(28)+" "+setE3.getString(29)));
                ...
                PdfPCell agriD5 = new PdfPCell(new Paragraph(setAvg.getString(28)+" "+setAvg.getString(29)));
                ...
                PdfPCell f2t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T1Avg.getString(30)))/11)+" "+setF2T1Avg.getString(31)));
                ...
                PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T2Avg.getString(30)))/11)+" "+setF1T2Avg.getString(31)));
                PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2"));
                PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T2Avg.getString(30)))/11)+" "+setF2T2Avg.getString(31)));
                ...
                PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3Avg.getString(30)))/11)+" "+setF1T3Avg.getString(31)));
                PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3"));
                PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+g));
            ...
            * */
               ...
               /* Get instance of CategoryPlot */
                ...
                dataSet.setValue((Integer.parseInt(setF1T1Avg.getString(30))/11), "Marks", "F1T1");
                dataSet.setValue((Integer.parseInt(setF1T2Avg.getString(30))/11), "Marks", "F1T2");
                dataSet.setValue((Integer.parseInt(setF1T3Avg.getString(30))/11), "Marks", "F1T3");
                dataSet.setValue((Integer.parseInt(setF2T1Avg.getString(30))/11), "Marks", "F2T1");
                dataSet.setValue((Integer.parseInt(setF2T2Avg.getString(30))/11), "Marks", "F2T2");
                dataSet.setValue(avgAvgTotal, "Marks", "F2T3");
    ...
    private void printBioCreBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell busD2 = new PdfPCell(new Paragraph(setE1.getString(26)+" "+setE1.getString(27)));
                PdfPCell busD3 = new PdfPCell(new Paragraph(setE2.getString(26)+" "+setE2.getString(27)));
                PdfPCell busD4 = new PdfPCell(new Paragraph(setE3.getString(26)+" "+setE3.getString(27)));
                ...
                PdfPCell busD5 = new PdfPCell(new Paragraph(setAvg.getString(26)+" "+setAvg.getString(27)));
    ...
    private void printBioHisAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell hisD2 = new PdfPCell(new Paragraph(setE1.getString(22)+" "+setE1.getString(23)));
                PdfPCell hisD3 = new PdfPCell(new Paragraph(setE2.getString(22)+" "+setE2.getString(23)));
                PdfPCell hisD4 = new PdfPCell(new Paragraph(setE3.getString(22)+" "+setE3.getString(23)));
                ...
                PdfPCell hisD5 = new PdfPCell(new Paragraph(setAvg.getString(22)+" "+setAvg.getString(23)));
    ...
    private void printBioGeoAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell geoD2 = new PdfPCell(new Paragraph(setE1.getString(20)+" "+setE1.getString(21)));
                PdfPCell geoD3 = new PdfPCell(new Paragraph(setE2.getString(20)+" "+setE2.getString(21)));
                PdfPCell geoD4 = new PdfPCell(new Paragraph(setE3.getString(20)+" "+setE3.getString(21)));
                ...
                PdfPCell geoD5 = new PdfPCell(new Paragraph(setAvg.getString(20)+" "+setAvg.getString(21)));
    ...
    private void printPhyCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell phyD2 = new PdfPCell(new Paragraph(setE1.getString(18)+" "+setE1.getString(19)));
                PdfPCell phyD3 = new PdfPCell(new Paragraph(setE2.getString(18)+" "+setE2.getString(19)));
                PdfPCell phyD4 = new PdfPCell(new Paragraph(setE3.getString(18)+" "+setE3.getString(19)));
                ...
                PdfPCell phyD5 = new PdfPCell(new Paragraph(setAvg.getString(18)+" "+setAvg.getString(19)));
    ...
    private void printAllSubjects(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell creD2 = new PdfPCell(new Paragraph(setE1.getString(24)+" "+setE1.getString(25),font));
                PdfPCell creD3 = new PdfPCell(new Paragraph(setE2.getString(24)+" "+setE2.getString(25),font));
                PdfPCell creD4 = new PdfPCell(new Paragraph(setE3.getString(24)+" "+setE3.getString(25),font));
                ...
                PdfPCell creD5 = new PdfPCell(new Paragraph(setAvg.getString(24)+" "+setAvg.getString(25),font));
                ...
                //float avgAvgTotal = (addAvgEx1+addAvgEx2+addAvgEx3)/3;
                int avgAvgTotal=Integer.parseInt(setAvg.getString(30))/11;
                ...
                PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T1Avg.getString(30)))/11)+" "+setF1T1Avg.getString(31),font));
                PdfPCell f2t1 = new PdfPCell(new Paragraph("F2T1",font));
                PdfPCell f2t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T1Avg.getString(30)))/11)+" "+setF2T1Avg.getString(31),font));
                ...
                PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T2Avg.getString(30)))/11)+" "+setF1T2Avg.getString(31),font));
                PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2",font));
                PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T2Avg.getString(30)))/11)+" "+setF2T2Avg.getString(31),font));
                ...
                PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3Avg.getString(30)))/11)+" "+setF1T3Avg.getString(31),font));
                PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3",font));
                PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+g,font));
