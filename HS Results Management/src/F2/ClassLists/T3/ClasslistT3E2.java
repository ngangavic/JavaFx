...
public class ClasslistT3E2 implements Initializable{
    ...
    public void showData(){
        String sql="SELECT * FROM tbl_f2_t3_ex2 WHERE class = 'FORM_1' ORDER BY total DESC ";
    ...
    private void calcTotal(){
        String sqlDet = "SELECT * FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f2_t3_ex2 SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f2_t3_ex2 SET grade=? WHERE adm=?";
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f2_t3_ex2 WHERE class = 'FORM_1' ORDER BY total DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(total) SUM_AVG FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f2_t3_ex2 WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F2T3Exam2ClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 2 TERM 3 EXAM 2", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing exam 2 results for FORM 2 TERM 3 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F2T3Exam2ClassResults.pdf"));
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
            }
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f2_t2_ex2 WHERE class = 'FORM_1' ORDER BY total DESC ";
        ...
        try{
            ...
            String names = "Form2_term3_exam2";
...
connection.close();
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlF2T1E2 = "SELECT * FROM tbl_f2_t1_ex2 WHERE adm=?";
            String sqlF2T2E2 = "SELECT * FROM tbl_f2_t2_ex2 WHERE adm=?";
            ...
            try{
                ...
                PreparedStatement statementE2F1T1 = connection.prepareStatement(sqlF1T1Ex2);
                PreparedStatement statementE2F1T2 = connection.prepareStatement(sqlF1T2Ex2);
                PreparedStatement statementE2F1T3 = connection.prepareStatement(sqlF1T3Ex2);
                PreparedStatement statementE2F2T1 = connection.prepareStatement(sqlF2T1E2);
                PreparedStatement statementE2F2T2 = connection.prepareStatement(sqlF2T2E2);
                ...
                statementE2F1T1.setString(1,adm);
                statementE2F1T2.setString(1,adm);
                statementE2F1T3.setString(1,adm);
                statementE2F2T1.setString(1,adm);
                statementE2F2T2.setString(1,adm);
                ...
                ResultSet setF1T1E2 = statementE2F1T1.executeQuery();
                ResultSet setF1T2E2 = statementE2F1T2.executeQuery();
                ResultSet setF1T3E2 = statementE2F1T3.executeQuery();
                ResultSet setF2T1E2 = statementE2F2T1.executeQuery();
                ResultSet setF2T2E2 = statementE2F2T2.executeQuery();
...
/* Get instance of CategoryPlot */
                ...
                dataSet.setValue((Integer.parseInt(setF1T1E2.getString(30))/11), "Marks", "F1T1");
                dataSet.setValue((Integer.parseInt(setF1T2E2.getString(30))/11), "Marks", "F1T2");
                dataSet.setValue((Integer.parseInt(setF1T3E2.getString(30))/11), "Marks", "F1T3");
                dataSet.setValue((Integer.parseInt(setF2T1E2.getString(30))/11), "Marks", "F2T1");
                dataSet.setValue((Integer.parseInt(setF2T2E2.getString(30))/11), "Marks", "F2T2");
