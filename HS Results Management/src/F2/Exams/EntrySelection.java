...
import F2.Exams.AgriEntry;
import F2.Exams.BioEntry;
import F2.Exams.BusEntry;
import F2.Exams.ChemEntry;
import F2.Exams.CreEntry;
import F2.Exams.EngEntry;
import F2.Exams.GeoEntry;
import F2.Exams.HisEntry;
import F2.Exams.KisEntry;
import F2.Exams.MatEntry;
import F2.Exams.PhyEntry;
import F2.Exams.subjectOption;
...
public class EntrySelection implements Initializable{
    ...
    private void kis(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 2 KISWAHILI");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void mat(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 2 MATHEMATICS");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void chem(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 2 CHEMISTRY");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void geo(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 2 GEOGRAPHY");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void bus(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 2 BUSINESS");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void agri(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 2 AGRICULTURE");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
