package F1.ClassLists.T3;

import F1.ReportForms.T3.*;
...
public class ClasslistT3E1 implements Initializable{
    ...
    public void showData(){
        String sql="SELECT * FROM tbl_f1_t3_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
    ...
    private void openAllSubjects(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/allSubjects.fxml"));
    ...
    private void openPhyHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/PhyHisBus.fxml"));
    ...
    private void openPhyHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/PhyHisAgri.fxml"));
    ...
    private void openPhyGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/PhyGeoBus.fxml"));
    ...
    private void openPhyGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/PhyGeoAgri.fxml"));
    ...
    private void openPhyCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/PhyCreBus.fxml"));
    ...
    private void openPhyCreAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/PhyCreAgri.fxml"));
    ...
    private void openBioHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/BioHisBus.fxml"));
    ...
    private void openBioHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/BioHisAgri.fxml"));
    ...
    private void openBioGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/BioGeoBus.fxml"));
    ...
    private void openBioGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/BioGeoAgri.fxml"));
    ...
    private void openBioCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/BioCreBus.fxml"));
    ...
    private void openBioCreAgri(String name){
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F1/ReportForms/T3/BioCreAgri.fxml"));
    ...
    private void calcTotal(){
        String sqlDet = "SELECT * FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f1_t3_ex1 SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f1_t3_ex1 SET grade=? WHERE adm=?";
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f1_t3_ex1 WHERE class = 'FORM_1' ORDER BY total DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(total) SUM_AVG FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f1_t3_ex1 WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new
                        FileOutputStream("F1T3Exam1ClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 1 TERM 3 EXAM 1", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F1T3Exam1ClassResults.pdf"));
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
            }
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f1_t2_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
...
connection.close();
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx1 = "SELECT * FROM tbl_f1_t2_ex1 WHERE adm=? ";
            String sqlEx1T1 = "SELECT * FROM tbl_f1_t1_ex1 WHERE adm=?";
            String sqlEx1T2 = "SELECT * FROM tbl_f1_t2_ex1 WHERE adm=?";
            ...
            try{
                ...
                PreparedStatement statementEx1F1T1 = connection.prepareStatement(sqlEx1T1);
                PreparedStatement statementEx1F1T2 = connection.prepareStatement(sqlEx1T2);



                statement.setString(1,adm);
                statementE1.setString(1,adm);
                statementEx1F1T1.setString(1,adm);
                statementEx1F1T2.setString(1,adm);


                ResultSet set = statement.executeQuery();
                ResultSet setE1 = statementE1.executeQuery();
                ResultSet setEx1F1T1 = statementEx1F1T1.executeQuery();
                ResultSet setEx1F1T2 = statementEx1F1T2.executeQuery();
                ...
                document.add((new Paragraph("ADM: "+set.getString(2)+"  "+"NAME: "+set.getString(3)+"   "+set.getString(4)+" "+set.getString(5)+"  "+"KCPE:"+set.getString(6)+"  "+"CLASS:FORM 1"+"  "+"TERM:TERM 3",new Font(Font.FontFamily.TIMES_ROMAN, 9,Font.BOLD))));
                ...
                // Integer.parseInt(setEx1F1T1.getString(30)/11)
                PdfPCell f1t1 = new PdfPCell(new Paragraph("F1T1"));
                PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setEx1F1T1.getString(30))/11)+" "+setEx1F1T1.getString(31)));
                ...
                PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setEx1F1T2.getString(30))/11)+" "+setEx1F1T2.getString(31)));
                ...
                PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+g));
...
/* Get instance of CategoryPlot */
                ...
                dataSet.setValue((Integer.parseInt(setEx1F1T1.getString(30))/11), "Marks", "F1T1");
                dataSet.setValue((Integer.parseInt(setEx1F1T2.getString(30))/11), "Marks", "F1T2");
    ...
    private void printAllSubjects(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setEx1F1T1.getString(30))/11)+" "+setEx1F1T1.getString(31),font));
                ...
                PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setEx1F1T2.getString(30))/11)+" "+setEx1F1T2.getString(31),font));
