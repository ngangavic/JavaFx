...
public class ClasslistT1E1 implements Initializable{
   ...
   public void showData(){
        String sql="SELECT * FROM tbl_f1_t1_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
...
connection.close();
    ...
    private void calcTotal(){
        String sqlDet = "SELECT * FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f1_t1_ex1 SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f1_t1_ex1 SET grade=? WHERE adm=?";
...
connection.close();
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f1_t1_ex1 WHERE class = 'FORM_1' ORDER BY total DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(total) SUM_AVG FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f1_t1_ex1 WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F1T1Exam1ClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 1 TERM 1 EXAM 1", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing exam 1 results for FORM 1 TERM 1 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F1T1Exam1ClassResults.pdf"));
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
            }
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f1_t1_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "));
