...
public class BusEntry implements Initializable{
    ...
    public void loadData(){
        String sql = "SELECT * FROM tbl_f1_bus WHERE class='FORM_1'";
    ...
    public void ex1t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex1=?,g1=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlEx = "UPDATE tbl_f1_t1_ex1 SET bus=?,busg=? WHERE id=?";
    ...
    public void ex2t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex2=?,g2=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlEx = "UPDATE tbl_f1_t1_ex2 SET bus=?,busg=? WHERE id=?";
    ...
    public void ex3t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex3=?,g3=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlAvg = "UPDATE tbl_f1_t1_avg SET bus=?,busg=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f1_t1_ex3 SET bus=?,busg=? WHERE id=?";
    ...
    public void ex1t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex4=?,g4=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlEx = "UPDATE tbl_f1_t2_ex1 SET bus=?,busg=? WHERE id=?";
    ...
    public void ex2t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex5=?,g5=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlEx = "UPDATE tbl_f1_t2_ex2 SET bus=?,busg=? WHERE id=?";
    ...
    public void ex3t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex6=?,g6=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlAvg = "UPDATE tbl_f1_t2_avg SET bus=?,busg=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f1_t2_ex3 SET bus=?,busg=? WHERE id=?";
        ...
        try{
            ...
            preparedStatement.execute();String g = "";
            if (avg >= Integer.parseInt(set.getString(4))) {g = "A"; } else if (avg >= Integer.parseInt(set.getString(5))) { g = "A-"; }else if (avg >=Integer.parseInt(set.getString(6))){ g = "B+";}else if (avg >=Integer.parseInt(set.getString(7))){
                g = "B"; }else if (avg >=Integer.parseInt(set.getString(8))){  g = "B-"; }else if (avg >=Integer.parseInt(set.getString(9))){ g = "C+"; }else if (avg >=Integer.parseInt(set.getString(10))){ g = "C";
            }else if (avg >=Integer.parseInt(set.getString(11))){ g = "C-";}else if (avg >=Integer.parseInt(set.getString(12))){ g = "D+";}else if (avg >=Integer.parseInt(set.getString(13))){ g = "D";}else if (avg >=Integer.parseInt(set.getString(14))){
                g = "D-";}else {g="E"; }
    ...
    public void ex1t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex7=?,g7=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlEx = "UPDATE tbl_f1_t3_ex1 SET bus=?,busg=? WHERE id=?";
    ...
    public void ex2t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex8=?,g8=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlEx = "UPDATE tbl_f1_t3_ex2 SET bus=?,busg=? WHERE id=?";
    ...
    public void ex3t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_bus SET ex9=?,g9=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='BUSINESS'";
        String sqlAvg = "UPDATE tbl_f1_t3_avg SET bus=?,busg=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f1_t3_ex3 SET bus=?,busg=? WHERE id=?";
