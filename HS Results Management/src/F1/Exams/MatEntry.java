...
public class MatEntry implements Initializable{
    ...
    public void loadData(){
        String sql = "SELECT * FROM tbl_f1_mat WHERE class='FORM_1'";
    ...
    public void ex1t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex1=?,g1=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlEx = "UPDATE tbl_f1_t1_ex1 SET mat=?,matg=? WHERE id=?";
    ...
    public void ex2t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex2=?,g2=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlEx = "UPDATE tbl_f1_t1_ex2 SET mat=?,matg=? WHERE id=?";
    ...
    public void ex3t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex3=?,g3=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlAvg = "UPDATE tbl_f1_t1_avg SET mat=?,matg=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f1_t1_ex3 SET mat=?,matg=? WHERE id=?";
    ...
    public void ex1t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex4=?,g4=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlEx = "UPDATE tbl_f1_t2_ex1 SET mat=?,matg=? WHERE id=?";
    ...
    public void ex2t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex5=?,g5=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlEx = "UPDATE tbl_f1_t2_ex2 SET mat=?,matg=? WHERE id=?";
    ...
    public void ex3t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex6=?,g6=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlAvg = "UPDATE tbl_f1_t2_avg SET mat=?,matg=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f1_t2_ex3 SET mat=?,matg=? WHERE id=?";
    ...
    public void ex1t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex7=?,g7=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlEx = "UPDATE tbl_f1_t3_ex1 SET mat=?,matg=? WHERE id=?";
    ...
    public void ex2t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex8=?,g8=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlEx = "UPDATE tbl_f1_t3_ex2 SET mat=?,matg=? WHERE id=?";
    ...
    public void ex3t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f1_mat SET ex9=?,g9=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='MATHEMATICS'";
        String sqlAvg = "UPDATE tbl_f1_t3_avg SET mat=?,matg=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f1_t3_ex3 SET mat=?,matg=? WHERE id=?";
