...
import F1.ReportForms.T2.PrintPass;
...
public class AllSubjects implements Initializable{
    ...
    private void setMarks(){
        String sqlEx1 = "SELECT * FROM tbl_f1_t2_ex1 WHERE class='FORM_1' AND adm=?";
        String sqlEx2 ="SELECT * FROM tbl_f1_t2_ex2 WHERE class='FORM_1' AND adm=?";
        String sqlEx3 ="SELECT * FROM tbl_f1_t2_ex3 WHERE class='FORM_1' AND adm=?";
        String sqlAvg ="SELECT * FROM tbl_f1_t2_avg WHERE class='FORM_1' AND adm=?";
...
/* Get instance of CategoryPlot */
    ...
    void printExam1(){
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM tbl_f1_t2_ex1 WHERE adm=? ";
            String sqlAvgT1 = "SELECT * FROM tbl_f1_t1_ex1 WHERE adm=? ";
    ...
    void printExam2(){
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='TOTAL'";
            String sqlEx2 = "SELECT * FROM tbl_f1_t2_ex2 WHERE adm=? ";
            String sqlAvgT1 = "SELECT * FROM tbl_f1_t1_ex2 WHERE adm=? ";
...
/* Get instance of CategoryPlot */
    ...
    void printExam3(){
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='TOTAL'";
            String sqlEx3 = "SELECT * FROM tbl_f1_t2_ex3 WHERE adm=? ";
            String sqlAvgT1 = "SELECT * FROM tbl_f1_t1_ex3 WHERE adm=? ";
