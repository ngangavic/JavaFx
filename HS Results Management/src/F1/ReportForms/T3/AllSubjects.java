...
/* Get instance of CategoryPlot */
    ...
    void printExam1(){
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlAvgT2 = "SELECT * FROM tbl_f1_t2_ex1 WHERE adm=? ";
    ...
    void printExam2(){
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlAvgT2 = "SELECT * FROM tbl_f1_t2_ex2 WHERE adm=? ";
...
/* Get instance of CategoryPlot */
    ...
    void printExam3(){
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlAvgT2 = "SELECT * FROM tbl_f1_t2_ex3 WHERE adm=? ";
