...
public class PhyEntry implements Initializable{
    ...
    public void loadData(){
        String sql = "SELECT * FROM tbl_f3_phy WHERE class='FORM_1'";
    ...
    public void ex1t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex1=?,g1=?,p1=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlEx = "UPDATE tbl_f3_t1_ex1 SET phy=?,phyg=?,p6=? WHERE id=?";
    ...
    public void ex2t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex2=?,g2=?,p2=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlEx = "UPDATE tbl_f3_t1_ex2 SET phy=?,phyg=?,p6=? WHERE id=?";
    ...
    public void ex3t1Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex3=?,g3=?,p3=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlAvg = "UPDATE tbl_f3_t1_avg SET phy=?,phyg=?,p6=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f3_t1_ex3 SET phy=?,phyg=?,p6=? WHERE id=?";
    ...
    public void ex1t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex4=?,g4=?,p4=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlEx = "UPDATE tbl_f3_t2_ex1 SET phy=?,phyg=?,p6=? WHERE id=?";
    ...
    public void ex2t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex5=?,g5=?,p5=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlEx = "UPDATE tbl_f3_t2_ex2 SET phy=?,phyg=?,p6=? WHERE id=?";
    ...
    public void ex3t2Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex6=?,g6=?,p6=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlAvg = "UPDATE tbl_f3_t2_avg SET phy=?,phyg=?,p6=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f3_t2_ex3 SET phy=?,phyg=?,p6=? WHERE id=?";
    ...
    public void ex1t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex7=?,g7=?,p7=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlEx = "UPDATE tbl_f3_t3_ex1 SET phy=?,phyg=?,p6=? WHERE id=?";
    ...
    public void ex2t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex8=?,g8=?,p8=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlEx = "UPDATE tbl_f3_t3_ex2 SET phy=?,phyg=?,p6=? WHERE id=?";
    ...
    public void ex3t3Update(TableColumn.CellEditEvent cellEditEvent){
        ...
        String sql= "UPDATE tbl_f3_phy SET ex9=?,g9=?,p9=? WHERE id=?";
        String sqlGrade = "SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='PHYSICS'";
        String sqlAvg = "UPDATE tbl_f3_t3_avg SET phy=?,phyg=?,p6=? WHERE id=?";
        String sqlEx = "UPDATE tbl_f3_t3_ex3 SET phy=?,phyg=?,p6=? WHERE id=?";
