...
import F3.ReportForms.T2.Reports;
import F3.ReportForms.T2.ReportsEx1;
import F3.ReportForms.T2.ReportsEx2;
import F3.ReportForms.T2.ReportsEx3;
...
public class AllSubjects implements Initializable{
    ...
    private void setDetails(){
        F3.ReportForms.T2.Reports.ADM=ADM;
        F3.ReportForms.T2.ReportsEx1.ADM=ADM;
        F3.ReportForms.T2.ReportsEx2.ADM=ADM;
        F3.ReportForms.T2.ReportsEx3.ADM=ADM;
        ...
        try{
            ...
            adm.setText(ADM);
            name.setText(names);
            F3.ReportForms.T2.Reports.NAME=names;
            F3.ReportForms.T2.Reports.POS=POS;
            F3.ReportForms.T2.Reports.ALL=String.valueOf(ALL);
            F3.ReportForms.T2.ReportsEx1.NAME=names;
            F3.ReportForms.T2.ReportsEx1.POS=POS;
            F3.ReportForms.T2.ReportsEx1.ALL=String.valueOf(ALL);
            F3.ReportForms.T2.ReportsEx2.NAME=names;
            F3.ReportForms.T2.ReportsEx2.POS=POS;
            F3.ReportForms.T2.ReportsEx2.ALL=String.valueOf(ALL);
            F3.ReportForms.T2.ReportsEx3.NAME=names;
            F3.ReportForms.T2.ReportsEx3.POS=POS;
            F3.ReportForms.T2.ReportsEx3.ALL=String.valueOf(ALL);
    ...
    private void setMarks(){
        String sqlEx1 = "SELECT * FROM tbl_f3_t2_ex1 WHERE class='FORM_1' AND adm=?";
        String sqlEx2 ="SELECT * FROM tbl_f3_t2_ex2 WHERE class='FORM_1' AND adm=?";
        String sqlEx3 ="SELECT * FROM tbl_f3_t2_ex3 WHERE class='FORM_1' AND adm=?";
        String sqlAvg ="SELECT * FROM tbl_f3_t2_avg WHERE class='FORM_1' AND adm=?";
    ...
    public void printPassAvg(){
        F3.ReportForms.T2.Reports.SUB=1;
        F3.ReportForms.T2.Reports reports = new Reports();
        reports.printPass();
    }

    public void printPassEx1(){
        F3.ReportForms.T2.ReportsEx1.SUB=1;
        F3.ReportForms.T2.ReportsEx1 reportsEx1 = new ReportsEx1();
        reportsEx1.printPass();
    }

    public void printPassEx2(){
        F3.ReportForms.T2.ReportsEx2.SUB=1;
        F3.ReportForms.T2.ReportsEx2 reportsEx2 = new ReportsEx2();
        reportsEx2.printPass();
    }

    public void printPassEx3(){
        F3.ReportForms.T2.ReportsEx3.SUB=1;
        F3.ReportForms.T2.ReportsEx3 reportsEx3 = new ReportsEx3();
    ...
    void printExamAvg() {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx3 = "SELECT * FROM tbl_f3_t2_ex3 WHERE adm=? ";
            String sqlAvg = "SELECT * FROM tbl_f3_t2_avg WHERE adm=? ";
