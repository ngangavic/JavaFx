...
public class ClasslistT3E3 implements Initializable{
    ...
    public void showData(){
        String sql="SELECT * FROM tbl_f3_t3_ex3 WHERE class = 'FORM_1' ORDER BY pt DESC ";
    ...
    private void calcTotal(){
        String sqlDet = "SELECT * FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f3_t3_ex3 SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f3_t3_ex3 SET grade=?,pt=? WHERE adm=?";
...
connection.close();
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f3_t3_ex3 WHERE class = 'FORM_1' ORDER BY pt DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(pt) SUM_PT FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f3_t3_ex3 WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F3T3E3ClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 3 TERM 3 EXAM 3", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing exam 3 results for FORM 3 TERM 3 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F3T3E3ClassResults.pdf"));
                connection.close();
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f3_t3_ex3 WHERE class = 'FORM_1' ORDER BY total DESC ";
        ...
        try{
            ...
            String names = "Form3_term3_exam3";
...
/* Get instance of CategoryPlot */
               ...
               dataSet.setValue((Integer.parseInt(setF1T1E3.getString(30))/11)/7, "Marks", "F1T1");
                ...
                dataSet.setValue(Float.parseFloat(setE3.getString(43)), "Marks", "F3T3");
    ...
    private void printAllSubjects(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setE3.getString(43)+" "+setE3.getString(42),font));
