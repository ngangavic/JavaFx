...
import F3.ClassLists.T3.Printpass;
import F3.ClassLists.T3.resultsData;
import F3.ReportForms.T3.*;
...
public class ClasslistT3E1 implements Initializable{
   ...
   public void showData(){
        String sql="SELECT * FROM tbl_f3_t3_ex1 WHERE class = 'FORM_1' ORDER BY pt DESC ";
...
e.printStackTrace();
       ...
       /*try{
            ...
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/allSubjects.fxml"));
    ...
    private void openPhyHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/PhyHisBus.fxml"));
    ...
    private void openPhyHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/PhyHisAgri.fxml"));
    ...
    private void openPhyGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/PhyGeoBus.fxml"));
    ...
    private void openPhyGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/PhyGeoAgri.fxml"));
    ...
    private void openPhyCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/PhyCreBus.fxml"));
    ...
    private void openPhyCreAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/PhyCreAgri.fxml"));
    ...
    private void openBioHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/BioHisBus.fxml"));
    ...
    private void openBioHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/BioHisAgri.fxml"));
    ...
    private void openBioGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/BioGeoBus.fxml"));
    ...
    private void openBioGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/BioGeoAgri.fxml"));
    ...
    private void openBioCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/BioCreBus.fxml"));
    ...
    private void openBioCreAgri(String name){
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F3/ReportForms/T3/BioCreAgri.fxml"));
    ...
    private void calcTotal() {
        String sqlDet = "SELECT * FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f3_t3_ex1 SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f3_t3_ex1 SET grade=?,pt=? WHERE adm=?";
...
e.printStackTrace();
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f3_t3_ex1 WHERE class = 'FORM_1' ORDER BY pt DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(pt) SUM_PT FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f3_t3_ex1 WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F3T3E1ClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 3 TERM 3 EXAM 1", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F3T3E1ClassResults.pdf"));
                connection.close();
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f3_t3_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3"));
                 PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setE1.getString(43)+" "+setE1.getString(42)));
...
/* Get instance of CategoryPlot */
                ...
                dataSet.setValue(Float.parseFloat(setE1.getString(43)), "Marks", "F3T3");
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3",font));
                 PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setE1.getString(43)+" "+setE1.getString(42),font));
