...
import F3.ClassLists.T1.ClasslistT1Avg;
import F3.ClassLists.T1.ClasslistT1E1;
import F3.ClassLists.T1.ClasslistT1E2;
import F3.ClassLists.T1.ClasslistT1E3;
import F3.ClassLists.T2.ClasslistT2Avg;
import F3.ClassLists.T2.ClasslistT2E1;
import F3.ClassLists.T2.ClasslistT2E2;
import F3.ClassLists.T2.ClasslistT2E3;
...
public class ClassListSelection implements Initializable {
    @FXML
    private ComboBox<term> cbTerm;
    @FXML
    private ComboBox<exam> cbExam;
    ...
    private void T1AVG(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 3 TERM 1 AVG");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void T2AVG(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 3 TERM 2 AVG");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void T3AVG(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 3 TERM 3 AVG");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
