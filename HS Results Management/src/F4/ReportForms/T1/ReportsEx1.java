package F4.ReportForms.T1;

import F4.ReportForms.T1.PrintPass;
...
/* Get instance of CategoryPlot */
                ...
                document.close();
            writer.close();
            infoBox("Document containing exam1 results for " +NAME + " has been generated open it for printing.","Done",null);
