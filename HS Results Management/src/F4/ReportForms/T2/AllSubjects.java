...
import F4.ReportForms.T2.Reports;
import F4.ReportForms.T2.ReportsEx1;
import F4.ReportForms.T2.ReportsEx2;
import F4.ReportForms.T2.ReportsEx3;
...
public class AllSubjects implements Initializable{
    ...
    private void setMarks(){
        String sqlEx1 = "SELECT * FROM tbl_f4_t2_ex1 WHERE class='FORM_1' AND adm=?";
        String sqlEx2 ="SELECT * FROM tbl_f4_t2_ex2 WHERE class='FORM_1' AND adm=?";
        String sqlEx3 ="SELECT * FROM tbl_f4_t2_ex3 WHERE class='FORM_1' AND adm=?";
        String sqlAvg ="SELECT * FROM tbl_f4_t2_avg WHERE class='FORM_1' AND adm=?";
    ...
    void printExamAvg() {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx2 = "SELECT * FROM tbl_f4_t2_ex2 WHERE adm=? ";
            String sqlEx3 = "SELECT * FROM tbl_f4_t2_ex3 WHERE adm=? ";
            String sqlAvg = "SELECT * FROM tbl_f4_t2_avg WHERE adm=? ";
