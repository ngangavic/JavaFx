...
import F4.ReportForms.T3.ReportsEx1;
import F4.ReportForms.T3.ReportsEx2;
import F4.ReportForms.T3.ReportsEx3;
...
public class AllSubjects implements Initializable{
    ...
    private void setDetails(){
        ...
        try{
            ...
            Reports.NAME=names;
            Reports.POS=POS;
            Reports.ALL=String.valueOf(ALL);
            ReportsEx1.NAME=names;
            ReportsEx1.POS=POS;
            ReportsEx1.ALL=String.valueOf(ALL);
            ReportsEx2.NAME=names;
            ReportsEx2.POS=POS;
            ReportsEx2.ALL=String.valueOf(ALL);
            ReportsEx3.NAME=names;
            ReportsEx3.POS=POS;
            ReportsEx3.ALL=String.valueOf(ALL);
    ...
    private void setMarks(){
        String sqlEx1 = "SELECT * FROM tbl_f4_t3_ex1 WHERE class='FORM_1' AND adm=?";
        String sqlEx2 ="SELECT * FROM tbl_f4_t3_ex2 WHERE class='FORM_1' AND adm=?";
        String sqlEx3 ="SELECT * FROM tbl_f4_t3_ex3 WHERE class='FORM_1' AND adm=?";
        String sqlAvg ="SELECT * FROM tbl_f4_t3_avg WHERE class='FORM_1' AND adm=?";
    ...
    void printExamAvg() {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx2 = "SELECT * FROM tbl_f4_t3_ex2 WHERE adm=? ";
            String sqlEx3 = "SELECT * FROM tbl_f4_t3_ex3 WHERE adm=? ";
            String sqlAvg = "SELECT * FROM tbl_f4_t3_avg WHERE adm=? ";
