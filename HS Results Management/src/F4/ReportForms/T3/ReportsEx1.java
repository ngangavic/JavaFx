...
import F4.ReportForms.T3.PrintPass;
...
public class ReportsEx1 {
    ...
    private void printBioCreAgri(String ADM,int POS, String ALL) {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx1 = "SELECT * FROM tbl_f4_t3_ex1 WHERE adm=? ";
...
/* Get instance of CategoryPlot */
               ...
               dataSet.setValue(Float.parseFloat(setE1.getString(43)), "Marks", "F4T3");
                ...
                document.close();
            writer.close();
            infoBox("Document containing exam1 results for " + NAME + " has been created open it for printing.","Done",null);
