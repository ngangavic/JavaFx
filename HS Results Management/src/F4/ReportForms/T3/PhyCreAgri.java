...
public class PhyCreAgri implements Initializable{
    ...
    private void setMarks(){
        ...
        try{
            ...
            avgEx1.setText(String.valueOf(Integer.parseInt(setEx1.getString(41))/7));
            avgEx2.setText(String.valueOf(Integer.parseInt(setEx2.getString(41))/7));
            avgEx3.setText(String.valueOf(Integer.parseInt(setEx3.getString(41))/7));
            avgAvg.setText(String.valueOf(Integer.parseInt(setAvg.getString(41))/7));
...
/* Get instance of CategoryPlot */
    ...
    void printExam1(){
        if(printPassword.toString().equals("vic")) {
			...
			String sqlEx1T1F1 = "SELECT * FROM tbl_f2_t1_ex1 WHERE adm=? ";
			String sqlEx1T2F1 = "SELECT * FROM tbl_f2_t2_ex1 WHERE adm=?";
    ...
    void printExam2(){
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx2 = "SELECT * FROM tbl_f4_t3_ex2 WHERE adm=? ";
String sqlEx2T1F1 = "SELECT * FROM tbl_f2_t1_ex2 WHERE adm=? ";
String sqlEx2T2F1 = "SELECT * FROM tbl_f2_t2_ex2 WHERE adm=? ";
...
/* Get instance of CategoryPlot */
    ...
    void printExam3(){
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='FORM_1' AND subject='TOTAL'";
            String sqlEx3 = "SELECT * FROM tbl_f4_t3_ex3 WHERE adm=? ";
			String sqlEx3T1F1 = "SELECT * FROM tbl_f2_t1_ex3 WHERE adm=? ";
			String sqlEx3T2F1 = "SELECT * FROM tbl_f2_t2_ex3 WHERE adm=? ";
