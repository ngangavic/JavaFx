...
import F4.Exams.AgriEntry;
import F4.Exams.BioEntry;
import F4.Exams.BusEntry;
import F4.Exams.ChemEntry;
import F4.Exams.CreEntry;
import F4.Exams.EngEntry;
import F4.Exams.GeoEntry;
import F4.Exams.HisEntry;
import F4.Exams.KisEntry;
import F4.Exams.MatEntry;
import F4.Exams.PhyEntry;
import F4.Exams.subjectOption;
...
public class EntrySelection implements Initializable{
    ...
    private void kis(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 KISWAHILI");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void mat(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 MATHEMATICS");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void chem(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 CHEMISTRY");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void geo(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 GEOGRAPHY");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void bus(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 BUSINESS");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void agri(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 AGRICULTURE");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
