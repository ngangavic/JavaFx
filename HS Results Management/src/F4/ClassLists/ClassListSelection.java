...
import F4.ClassLists.T1.ClasslistT1Avg;
import F4.ClassLists.T1.ClasslistT1E1;
import F4.ClassLists.T1.ClasslistT1E2;
import F4.ClassLists.T1.ClasslistT1E3;
...
import F4.ClassLists.T3.ClasslistT3Avg;
import F4.ClassLists.T3.ClasslistT3E1;
import F4.ClassLists.T3.ClasslistT3E2;
import F4.ClassLists.T3.ClasslistT3E3;
import F4.ClassLists.exam;
import F4.ClassLists.term;
...
public class ClassListSelection implements Initializable {
    @FXML
    private ComboBox<F4.ClassLists.term> cbTerm;
    @FXML
    private ComboBox<F4.ClassLists.exam> cbExam;
    ...
    private void T1AVG(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 TERM 1 AVG");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void T2AVG(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 TERM 2 AVG");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
    ...
    private void T3AVG(){
        try{
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("FORM 4 TERM 3 AVG");
            stage.setResizable(true);
            stage.show();
        }catch (IOException e){
            infoBoxError("An error occurred" + e ,"ERROR",null);
