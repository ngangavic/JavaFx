...
import F4.ClassLists.T2.Printpass;
import F4.ClassLists.T2.resultsData;
import F4.ReportForms.T2.*;
...
public class ClasslistT2E1 implements Initializable{
   ...
   public void showData(){
        String sql="SELECT * FROM tbl_f4_t2_ex1 WHERE class = 'FORM_1' ORDER BY pt DESC ";
...
e.printStackTrace();
       ...
       /*try{
            ...
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/allSubjects.fxml"));
    ...
    private void openPhyHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/PhyHisBus.fxml"));
    ...
    private void openPhyHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/PhyHisAgri.fxml"));
    ...
    private void openPhyGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/PhyGeoBus.fxml"));
    ...
    private void openPhyGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/PhyGeoAgri.fxml"));
    ...
    private void openPhyCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/PhyCreBus.fxml"));
    ...
    private void openPhyCreAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/PhyCreAgri.fxml"));
    ...
    private void openBioHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/BioHisBus.fxml"));
    ...
    private void openBioHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/BioHisAgri.fxml"));
    ...
    private void openBioGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/BioGeoBus.fxml"));
    ...
    private void openBioGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/BioGeoAgri.fxml"));
    ...
    private void openBioCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/BioCreBus.fxml"));
    ...
    private void openBioCreAgri(String name){
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T2/BioCreAgri.fxml"));
    ...
    private void calcTotal() {
        String sqlDet = "SELECT * FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f4_t2_ex1 SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f4_t2_ex1 SET grade=?,pt=? WHERE adm=?";
...
e.printStackTrace();
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f4_t2_ex1 WHERE class = 'FORM_1' ORDER BY pt DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(pt) SUM_PT FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f4_t2_ex1 WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F4T2E1ClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 4 TERM 1 EXAM 1", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing exam 1 results for FORM 4 TERM 1 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F4T2E1ClassResults.pdf"));
                connection.close();
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f4_t2_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
        ...
        try{
            ...
            document.close();
            writer.close();
            infoBox("Document containing exam 1 results for form 4 term 2 has been created open it for printing.","Done",null);
...
e.printStackTrace();
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            String sqlEx1 = "SELECT * FROM tbl_f4_t2_ex1 WHERE adm=? ";
            String sqlF1T1Ex1 = "SELECT * FROM tbl_f1_t1_ex1 WHERE adm=?";
            String sqlF1T2Ex1 = "SELECT * FROM tbl_f1_t2_ex1 WHERE adm=?";
            String sqlF1T3Ex1 = "SELECT * FROM tbl_f1_t3_ex1 WHERE adm=?";
            String sqlF2T1Ex1 = "SELECT * FROM tbl_f2_t1_ex1 WHERE adm=?";
            String sqlF2T2Ex1 = "SELECT * FROM tbl_f2_t2_ex1 WHERE adm=?";
            String sqlF2T3Ex1 = "SELECT * FROM tbl_f2_t3_ex1 WHERE adm=?";
            String sqlF3T1Ex1 = "SELECT * FROM tbl_f3_t1_ex1 WHERE adm=?";
            String sqlF3T2Ex1 = "SELECT * FROM tbl_f3_t2_ex1 WHERE adm=?";
            String sqlF3T3Ex1 = "SELECT * FROM tbl_f3_t3_ex1 WHERE adm=?";
            String sqlF4T1Ex1 = "SELECT * FROM tbl_f4_t1_ex1 WHERE adm=?";
            String sqlF4T2Ex1 = "SELECT * FROM tbl_f4_t2_ex1 WHERE adm=?";
            String sqlF4T3Ex1 = "SELECT * FROM tbl_f4_t3_ex1 WHERE adm=?";
            ...
            try{
                ...
                document.add((new Paragraph("ADM: "+set.getString(2)+"  "+"NAME: "+set.getString(3)+"   "+set.getString(4)+" "+set.getString(5)+"  "+"KCPE:"+set.getString(6)+"  "+"CLASS:FORM 4"+"  "+"TERM:TERM 2",new Font(Font.FontFamily.TIMES_ROMAN, 9,Font.BOLD))));
                ...
                PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setE1.getString(42)+" "+setE1.getString(43)));
...
/* Get instance of CategoryPlot */
                ...
                dataSet.setValue(Float.parseFloat(setE1.getString(43)), "Marks", "F4T2");
    ...
    private void printAllSubjects(String adm, Document document, PdfWriter writer, int pos, String totalStudents) {
        if(printPassword.toString().equals("vic")) {
            ...
            try{
                ...
                PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setE1.getString(42)+" "+setE1.getString(43),font));
                tableLastSummary.addCell(f1t2);
                tableLastSummary.addCell(f1t2m);
                tableLastSummary.addCell(f2t2);
                tableLastSummary.addCell(f2t2m);
