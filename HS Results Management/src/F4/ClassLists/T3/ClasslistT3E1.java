package F4.ClassLists.T3;

import F4.ClassLists.T3.Printpass;
import F4.ClassLists.T3.resultsData;
...
public class ClasslistT3E1 implements Initializable{
   ...
   public void showData(){
        String sql="SELECT * FROM tbl_f4_t3_ex1 WHERE class = 'FORM_1' ORDER BY pt DESC ";
...
e.printStackTrace();
    ...
    public void onStudentClick(){
        // String bio="",phy="",chem="";
        int bio=0,phy=0,chem=0,geo=0,his=0,cre=0,bus=0,agri=0;
        ...
        try{
            ...
            set = statement.executeQuery();
             bio= Integer.parseInt(set.getString(11));
             phy= Integer.parseInt(set.getString(13));
             geo= Integer.parseInt(set.getString(14));
             his= Integer.parseInt(set.getString(15));
             cre= Integer.parseInt(set.getString(16));
             bus= Integer.parseInt(set.getString(17));
             agri= Integer.parseInt(set.getString(18));

            if (bio==1&&phy==1&&geo==1&&his==1&&cre==1&&bus==1&&agri==1){
...
e.printStackTrace();
       ...
       /*try{
            ...
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/allSubjects.fxml"));
    ...
    private void openPhyHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/PhyHisBus.fxml"));
    ...
    private void openPhyHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/PhyHisAgri.fxml"));
    ...
    private void openPhyGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/PhyGeoBus.fxml"));
    ...
    private void openPhyGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/PhyGeoAgri.fxml"));
    ...
    private void openPhyCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/PhyCreBus.fxml"));
    ...
    private void openPhyCreAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/PhyCreAgri.fxml"));
    ...
    private void openBioHisBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/BioHisBus.fxml"));
    ...
    private void openBioHisAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/BioHisAgri.fxml"));
    ...
    private void openBioGeoBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/BioGeoBus.fxml"));
    ...
    private void openBioGeoAgri(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/BioGeoAgri.fxml"));
    ...
    private void openBioCreBus(String name) {
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/BioCreBus.fxml"));
    ...
    private void openBioCreAgri(String name){
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("/F4/ReportForms/T3/BioCreAgri.fxml"));
    ...
    private void calcTotal() {
        String sqlDet = "SELECT * FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f4_t3_ex1 SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f4_t3_ex1 SET grade=?,pt=? WHERE adm=?";
...
e.printStackTrace();
    ...
    public void printClassResults(){
        ...
        if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f4_t3_ex1 WHERE class = 'FORM_1' ORDER BY pt DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(pt) SUM_PT FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f4_t3_ex1 WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F4T3E1ClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 4 TERM 3 EXAM 1", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing exam 1 results for FORM 3 TERM 3 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F4T3E1ClassResults.pdf"));
                connection.close();
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f4_t3_ex1 WHERE class = 'FORM_1' ORDER BY total DESC ";
        ...
        try{
            ...
            document.close();
            writer.close();
            infoBox("Document containing exam 1 results for form 4 term 3 has been created open it for printing.","Done",null);
...
e.printStackTrace();
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls) {
            ...
            String sqlEx1 = "SELECT * FROM tbl_f4_t3_"+ex+" WHERE adm=? ";
            String sqlF1T1Ex1 = "SELECT * FROM tbl_f1_t1_"+ex+" WHERE adm=?";
            String sqlF1T2Ex1 = "SELECT * FROM tbl_f1_t2_"+ex+" WHERE adm=?";
            String sqlF1T3Ex1 = "SELECT * FROM tbl_f1_t3_"+ex+" WHERE adm=?";
            String sqlF2T1Ex1 = "SELECT * FROM tbl_f2_t1_"+ex+" WHERE adm=?";
            String sqlF2T2Ex1 = "SELECT * FROM tbl_f2_t2_"+ex+" WHERE adm=?";
            String sqlF2T3Ex1 = "SELECT * FROM tbl_f2_t3_"+ex+" WHERE adm=?";
            String sqlF3T1Ex1 = "SELECT * FROM tbl_f3_t1_"+ex+" WHERE adm=?";
            String sqlF3T2Ex1 = "SELECT * FROM tbl_f3_t2_"+ex+" WHERE adm=?";
            String sqlF3T3Ex1 = "SELECT * FROM tbl_f3_t3_"+ex+" WHERE adm=?";
            String sqlF4T1Ex1 = "SELECT * FROM tbl_f4_t1_"+ex+" WHERE adm=?";
            String sqlF4T2Ex1 = "SELECT * FROM tbl_f4_t2_"+ex+" WHERE adm=?";
            String sqlF4T3Ex1 = "SELECT * FROM tbl_f4_t3_"+ex+" WHERE adm=?";
            ...
            try{
                ...
                PreparedStatement statementF1T1E1 = connection.prepareStatement(sqlF1T1Ex1);
                PreparedStatement statementF1T2E1 = connection.prepareStatement(sqlF1T2Ex1);
                PreparedStatement statementF1T3E1 = connection.prepareStatement(sqlF1T3Ex1);
                PreparedStatement statementF2T1E1 = connection.prepareStatement(sqlF2T1Ex1);
                PreparedStatement statementF2T2E1 = connection.prepareStatement(sqlF2T2Ex1);
                PreparedStatement statementF2T3E1 = connection.prepareStatement(sqlF2T3Ex1);
                PreparedStatement statementF3T1E1 = connection.prepareStatement(sqlF3T1Ex1);
                PreparedStatement statementF3T2E1 = connection.prepareStatement(sqlF3T2Ex1);
                PreparedStatement statementF3T3E1 = connection.prepareStatement(sqlF3T3Ex1);
                PreparedStatement statementF4T1E1 = connection.prepareStatement(sqlF4T1Ex1);
                PreparedStatement statementF4T2E1 = connection.prepareStatement(sqlF4T2Ex1);
                PreparedStatement statementF4T3E1 = connection.prepareStatement(sqlF4T3Ex1);
                


                statement.setString(1,adm);
                statementE1.setString(1,adm);
                statementF1T1E1.setString(1,adm);
                statementF1T2E1.setString(1,adm);
                statementF1T3E1.setString(1,adm);
                statementF2T1E1.setString(1,adm);
                statementF2T2E1.setString(1,adm);
                statementF2T3E1.setString(1,adm);
                statementF3T1E1.setString(1,adm);
                statementF3T2E1.setString(1,adm);
                statementF3T3E1.setString(1,adm);
                statementF4T1E1.setString(1,adm);
                statementF4T2E1.setString(1,adm);
                statementF4T3E1.setString(1,adm);
                
                ResultSet set = statement.executeQuery();
                ResultSet setE1 = statementE1.executeQuery();
                ResultSet setF1T1E1 = statementF1T1E1.executeQuery();
                ResultSet setF1T2E1 = statementF1T2E1.executeQuery();
                ResultSet setF1T3E1 = statementF1T3E1.executeQuery();
                ResultSet setF2T1E1 = statementF2T1E1.executeQuery();
                ResultSet setF2T2E1 = statementF2T2E1.executeQuery();
                ResultSet setF2T3E1 = statementF2T3E1.executeQuery();
                ResultSet setF3T1E1 = statementF3T1E1.executeQuery();
                ResultSet setF3T2E1 = statementF3T2E1.executeQuery();
                ResultSet setF3T3E1 = statementF3T3E1.executeQuery();
                ResultSet setF4T1E1 = statementF4T1E1.executeQuery();
                ResultSet setF4T2E1 = statementF4T2E1.executeQuery();
                ResultSet setF4T3E1 = statementF4T3E1.executeQuery();
                ...
                PdfPCell engD5 = new PdfPCell(new Paragraph(setE1.getString(8)+" "+setE1.getString(9)));
                ...
                int avgKis= Integer.parseInt(setE1.getString(11));
                if (avgKis >= Integer.parseInt(setKisGrade.getString(4))) {com = setComments.getString(2); } else if (avgKis >= Integer.parseInt(setKisGrade.getString(5))) { com = setComments.getString(3); }else if (avgKis >=Integer.parseInt(setKisGrade.getString(6))){ com = setComments.getString(4);}else if (avgKis >=Integer.parseInt(setKisGrade.getString(7))){
                    ...
                    com = setComments.getString(12);}else {com = setComments.getString(13); }
                PdfPCell kisD5 = new PdfPCell(new Paragraph(setE1.getString(11)+" "+setE1.getString(12)));
                ...
                int avgMat = Integer.parseInt(setE1.getString(14));
                ...
                PdfPCell matD5 = new PdfPCell(new Paragraph(setE1.getString(14)+" "+setE1.getString(15)));
                ...
                int avgChem = Integer.parseInt(setE1.getString(20));
                ...
                PdfPCell chemD5 = new PdfPCell(new Paragraph(setE1.getString(20)+" "+setE1.getString(21)));
                ...
                int avgBio = Integer.parseInt(setE1.getString(17));
                ...
                PdfPCell bioD5 = new PdfPCell(new Paragraph(setE1.getString(17)+" "+setE1.getString(18)));
                ...
                int avgCre = Integer.parseInt(setE1.getString(32));
                ...
                PdfPCell creD5 = new PdfPCell(new Paragraph(setE1.getString(32)+" "+setE1.getString(33)));
                ...
                int avgAgri = Integer.parseInt(setE1.getString(38));
                ...
                PdfPCell agriD5 = new PdfPCell(new Paragraph(setE1.getString(38)+" "+setE1.getString(39)));
                ...
                int totalAvg = Integer.parseInt(setE1.getString(41));
                ...
                PdfPCell totalD5 = new PdfPCell(new Paragraph(String.valueOf(totalE1)));
                ...
                PdfPCell avgD2 = new PdfPCell(new Paragraph(String.valueOf(addAvgEx1)+" "+setE1.getString(42)));
                ...
                int avgAvgTotal=Integer.parseInt(setE1.getString(41))/7;
                ...
                PdfPCell avgD5 = new PdfPCell(new Paragraph(String.valueOf(Math.round(avgAvgTotal))+" "+setE1.getString(42)));
                ...
                PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T1E1.getString(30)))/11)+" "+setF1T1E1.getString(31)));
                PdfPCell f2t1 = new PdfPCell(new Paragraph("F2T1"));
                PdfPCell f2t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T1E1.getString(30)))/11)+" "+setF2T1E1.getString(31)));
                PdfPCell f3t1 = new PdfPCell(new Paragraph("F3T1"));
                PdfPCell f3t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T1E1.getString(41))/11)+" "+setF3T1E1.getString(43)+" "+setF3T1E1.getString(42)));
                PdfPCell f4t1 = new PdfPCell(new Paragraph("F4T1"));
                PdfPCell f4t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T1E1.getString(41))/11)+" "+setF4T1E1.getString(43)+" "+setF4T1E1.getString(42)));
                ...
                PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T2E1.getString(30)))/11)+" "+setF1T2E1.getString(31)));
                PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2"));
                PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T2E1.getString(30)))/11)+" "+setF2T2E1.getString(31)));
                PdfPCell f3t2 = new PdfPCell(new Paragraph("F3T2"));
                PdfPCell f3t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T2E1.getString(41))/11)+" "+setF3T2E1.getString(43)+" "+setF3T2E1.getString(42)));
                PdfPCell f4t2 = new PdfPCell(new Paragraph("F4T2"));
                PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T2E1.getString(41))/11)+" "+setF4T2E1.getString(43)+" "+setF4T2E1.getString(42)));
                ...
                PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3E1.getString(30)))/11)+" "+setF1T3E1.getString(31)));
                PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3"));
                PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T3E1.getString(30)))/11)+" "+setF2T3E1.getString(31)));
                PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3"));
                PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T3E1.getString(41))/11)+" "+setF3T3E1.getString(43)+" "+setF3T3E1.getString(42)));
                PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3"));
               PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setE1.getString(43)+" "+setE1.getString(42)));
...
/* Get instance of CategoryPlot */
                ...
                dataSet.setValue((Integer.parseInt(setF1T1E1.getString(30))/11)/7, "Marks", "F1T1");
                dataSet.setValue((Integer.parseInt(setF1T2E1.getString(30))/11)/7, "Marks", "F1T2");
                dataSet.setValue((Integer.parseInt(setF1T3E1.getString(30))/11)/7, "Marks", "F1T3");
                dataSet.setValue((Integer.parseInt(setF2T1E1.getString(30))/11)/7, "Marks", "F2T1");
                dataSet.setValue((Integer.parseInt(setF2T2E1.getString(30))/11)/7, "Marks", "F2T2");
                dataSet.setValue((Integer.parseInt(setF2T3E1.getString(30))/11)/7, "Marks", "F2T3");
                dataSet.setValue(Float.parseFloat(setF3T1E1.getString(43)), "Marks", "F3T1");
                dataSet.setValue(Float.parseFloat(setF3T2E1.getString(43)), "Marks", "F3T2");
                dataSet.setValue(Float.parseFloat(setF3T3E1.getString(43)), "Marks", "F3T3");
                dataSet.setValue(Float.parseFloat(setF4T1E1.getString(43)), "Marks", "F4T1");
                dataSet.setValue(Float.parseFloat(setF4T2E1.getString(43)), "Marks", "F4T2");
               dataSet.setValue(Float.parseFloat(setE1.getString(43)), "Marks", "F4T3");
...
e.printStackTrace();
    ...
    private void printBioCreBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls) {
            ...
            try{
                ...
                PreparedStatement statementF1T1E1 = connection.prepareStatement(sqlF1T1Ex1);
                PreparedStatement statementF1T2E1 = connection.prepareStatement(sqlF1T2Ex1);
                PreparedStatement statementF1T3E1 = connection.prepareStatement(sqlF1T2Ex1);
                PreparedStatement statementF2T1E1 = connection.prepareStatement(sqlF2T1Ex1);
                PreparedStatement statementF2T2E1 = connection.prepareStatement(sqlF2T2Ex1);
                PreparedStatement statementF2T3E1 = connection.prepareStatement(sqlF2T3Ex1);
                PreparedStatement statementF3T1E1 = connection.prepareStatement(sqlF3T1Ex1);
                ...
                int avgBus = Integer.parseInt(setE1.getString(35));
                ...
                PdfPCell busD5 = new PdfPCell(new Paragraph(setE1.getString(35)+" "+setE1.getString(36)));
    ...
    private void printBioHisAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            ...
            try{
                ...
                int avgHis = Integer.parseInt(setE1.getString(29));
                ...
                PdfPCell hisD5 = new PdfPCell(new Paragraph(setE1.getString(29)+" "+setE1.getString(30)));
    ...
    private void printBioGeoAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            ...
            try{
                ...
                int avgGeo = Integer.parseInt(setE1.getString(26));
                ...
                PdfPCell geoD5 = new PdfPCell(new Paragraph(setE1.getString(26)+" "+setE1.getString(27)));
    ...
    private void printPhyCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            ...
            try{
                ...
                int avgPhy = Integer.parseInt(setE1.getString(23));
                ...
                PdfPCell phyD5 = new PdfPCell(new Paragraph(setE1.getString(23)+" "+setE1.getString(24)));
        ...
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            ...
            try{
                ...
                if (avgKis >= Integer.parseInt(setKisGrade.getString(4))) {com = setComments.getString(2); } else if (avgKis >= Integer.parseInt(setKisGrade.getString(5))) { com = setComments.getString(3); }else if (avgKis >=Integer.parseInt(setKisGrade.getString(6))){ com = setComments.getString(4);}else if (avgKis >=Integer.parseInt(setKisGrade.getString(7))){
                    ...
                    com = setComments.getString(12);}else {com = setComments.getString(13); }
                PdfPCell kisD5 = new PdfPCell(new Paragraph(setE1.getString(11)+" "+setE1.getString(12),font));
                ...
                PdfPCell matD5 = new PdfPCell(new Paragraph(setE1.getString(14)+" "+setE1.getString(15),font));
                ...
                PdfPCell chemD5 = new PdfPCell(new Paragraph(setE1.getString(20)+" "+setE1.getString(21),font));
                ...
                PdfPCell bioD5 = new PdfPCell(new Paragraph(setE1.getString(17)+" "+setE1.getString(18),font));
                ...
                PdfPCell phyD5 = new PdfPCell(new Paragraph(setE1.getString(23)+" "+setE1.getString(24),font));
                ...
                PdfPCell hisD5 = new PdfPCell(new Paragraph(setE1.getString(29)+" "+setE1.getString(30),font));
                ...
                PdfPCell geoD5 = new PdfPCell(new Paragraph(setE1.getString(26)+" "+setE1.getString(27),font));
                ...
                PdfPCell creD5 = new PdfPCell(new Paragraph(setE1.getString(32)+" "+setE1.getString(33),font));
                ...
                PdfPCell busD5 = new PdfPCell(new Paragraph(setE1.getString(35)+" "+setE1.getString(36),font));
                ...
                PdfPCell agriD5 = new PdfPCell(new Paragraph(setE1.getString(38)+" "+setE1.getString(39),font));
                ...
                //float avgAvgTotal = (addAvgEx1+addAvgEx2+addAvgEx3)/3;
                int avgAvgTotal=Integer.parseInt(setE1.getString(41))/11;
                ...
                PdfPCell avgD5 = new PdfPCell(new Paragraph(String.valueOf(Math.round(avgAvgTotal))+" "+setE1.getString(42),font));
                ...
                PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T1E1.getString(30)))/11)+" "+setF1T1E1.getString(31),font));
                PdfPCell f2t1 = new PdfPCell(new Paragraph("F2T1",font));
                PdfPCell f2t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T1E1.getString(30)))/11)+" "+setF2T1E1.getString(31),font));
                PdfPCell f3t1 = new PdfPCell(new Paragraph("F3T1",font));
                PdfPCell f3t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T1E1.getString(41))/11)+" "+setF3T1E1.getString(43)+" "+setF3T1E1.getString(42),font));

                PdfPCell f4t1 = new PdfPCell(new Paragraph("F4T1",font));
                PdfPCell f4t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T1E1.getString(41))/11)+" "+setF4T1E1.getString(43)+" "+setF4T1E1.getString(42),font));
                tableLastSummary.addCell(f1t1);
                tableLastSummary.addCell(f1t1m);
                tableLastSummary.addCell(f2t1);
                tableLastSummary.addCell(f2t1m);
                ...
                PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T2E1.getString(30)))/11)+" "+setF1T2E1.getString(31),font));
                PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2",font));
                PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T2E1.getString(30)))/11)+" "+setF2T2E1.getString(31),font));
                PdfPCell f3t2 = new PdfPCell(new Paragraph("F3T2",font));
                PdfPCell f3t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T2E1.getString(41))/11)+" "+setF3T2E1.getString(43)+" "+setF3T2E1.getString(42),font));
                PdfPCell f4t2 = new PdfPCell(new Paragraph("F4T2",font));
                PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T2E1.getString(41))/11)+" "+setF4T2E1.getString(43)+" "+setF4T2E1.getString(42),font));
                tableLastSummary.addCell(f1t2);
                tableLastSummary.addCell(f1t2m);
                tableLastSummary.addCell(f2t2);
                tableLastSummary.addCell(f2t2m);
                ...
                PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3E1.getString(30)))/11)+" "+setF1T3E1.getString(31),font));
                PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3",font));
                PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T3E1.getString(30)))/11)+" "+setF2T3E1.getString(31),font));
                PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3",font));
                PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T3E1.getString(41))/11)+" "+setF3T3E1.getString(43)+" "+setF3T3E1.getString(42),font));
                PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3",font));
                PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setE1.getString(43)+" "+setE1.getString(42),font));
                tableLastSummary.addCell(f1t3);
                tableLastSummary.addCell(f1t3m);
                tableLastSummary.addCell(f2t3);
                tableLastSummary.addCell(f2t3m);
