...
public class ClasslistT3Avg implements Initializable{
    String cname = System.getProperty("user.home");
    Calendar now = Calendar.getInstance();
    @FXML private TableView<resultsData> tableAllResults;
    ...
    public void showData(){
        String sql="SELECT * FROM tbl_f4_t3_avg WHERE class = 'FORM_1' ORDER BY pt DESC ";
        //String sql="SELECT * FROM tbl_f4_t3_avg WHERE class = 'FORM_1' ORDER BY total ASC ";
    ...
    private void calcTotal(){
        String sqlDet = "SELECT * FROM tbl_f4_t3_avg WHERE class='FORM_1'";
        String sqlUpdate = "UPDATE tbl_f4_t3_avg SET total=? WHERE adm=?";
        String sqlUpdate2 = "UPDATE tbl_f4_t3_avg SET grade=?,pt=? WHERE adm=?";
...
connection.close();
    ...
    public void printClassResults(){
       ...
       if(printPassword.toString().equals("vic")) {
            ...
            String sql = "SELECT * FROM tbl_f4_t3_avg WHERE class = 'FORM_1' ORDER BY pt DESC";
            String engSum = "SELECT AVG(eng) SUM_ENG FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String kisSum = "SELECT AVG(kis) SUM_KIS FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String matSum = "SELECT AVG(mat) SUM_MAT FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String chemSum = "SELECT AVG(chem) SUM_CHEM FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String bioSum = "SELECT AVG(bio) SUM_BIO FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String phySum = "SELECT AVG(phy) SUM_PHY FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String geoSum = "SELECT AVG(geo) SUM_GEO FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String hisSum = "SELECT AVG(his) SUM_HIS FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String creSum = "SELECT AVG(cre) SUM_CRE FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String busSum = "SELECT AVG(bus) SUM_BUS FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String agriSum = "SELECT AVG(agri) SUM_AGRI FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String totalSum = "SELECT AVG(total) SUM_TOTAL FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String avgSum = "SELECT AVG(pt) SUM_PT FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            String kcpeSum = "SELECT AVG(kcpe) SUM_KCPE FROM tbl_f4_t3_avg WHERE class='FORM_1'";
            try {
                Connection connection = Database.DBConnection.getConnection();
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("F4T3AverageClassResults.pdf"));
                document.open();
                ...
                Paragraph reportType = new Paragraph("FORM 4 TERM 3 AVERAGE", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD));
                ...
                document.close();
                writer.close();
                infoBox("Document containing average results for FORM 4 TERM 3 has been created open it for printing.", "Done", null);
                Desktop.getDesktop().open(new File(cname+"\\HS Results\\F4T3AverageClassResults.pdf"));
            connection.close();
            } catch (Exception e) {
                infoBoxError("An error occurred " + e, "error", null);
                e.printStackTrace();
    ...
    public void printAllResults(){
        ...
        String sqlStudents="SELECT * FROM tbl_f4_t3_avg WHERE class = 'FORM_1' ORDER BY pt DESC ";
        ...
        try{
           ...
           // }
            ...
            String names = "Form4_term3_average";
            ...
            document.close();
            writer.close();
            infoBox("Document containing average results for form 4 term 2 has been created open it for printing.","Done",null);
...
connection.close();
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
            ...
            try{
                ...
                if (addAvgEx2 >= Integer.parseInt(setTotal.getString(4))) {g = "A"; } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(5))) { g = "A-"; }else if (addAvgEx2 >=Integer.parseInt(setTotal.getString(6))){ g = "B+";}else if (addAvgEx2 >=Integer.parseInt(setTotal.getString(7))){
                    ...
                    g = "D-";}else {g="E"; }
                PdfPCell avgD3 = new PdfPCell(new Paragraph(String.valueOf(addAvgEx2)+" "+setE2.getString(42)));
                ...
                PdfPCell avgD5 = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setAvg.getString(42)));
                ...
                PdfPCell f4t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T1Avg.getString(41))/11)+" "+setF4T1Avg.getString(43)+" "+setF4T1Avg.getString(42)));
                ...
                PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T2Avg.getString(41))/11)+" "+setF4T2Avg.getString(43)+" "+setF4T2Avg.getString(42)));
                ...
                PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setAvg.getString(42)+" "+setAvg.getString(43)));
            ...
            * */
               ...
               /* Get instance of CategoryPlot */
                ...
                dataSet.setValue(Float.parseFloat(setAvg.getString(43)), "Marks", "F4T3");
...
connection.close();
    ...
    private void printBioCreBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
document.add((new Paragraph(" ")));
                ...
                PdfPCell f1t2 = new PdfPCell(new Paragraph("F1T2"));
                PdfPCell f1t2m = new PdfPCell(new Paragraph(String.format("%.1f",(Float.parseFloat(setF1T2Avg.getString(30)))/11)+" "+setF1T2Avg.getString(31)));
                PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2"));
                PdfPCell f2t2m = new PdfPCell(new Paragraph(String.format("%.1f",(Float.parseFloat(setF2T2Avg.getString(30)))/11)+" "+setF2T2Avg.getString(31)));
                PdfPCell f3t2 = new PdfPCell(new Paragraph("F3T2"));
                PdfPCell f3t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T2Avg.getString(41))/11)+" "+setF3T2Avg.getString(43)+" "+setF3T2Avg.getString(42)));
                PdfPCell f4t2 = new PdfPCell(new Paragraph("F4T2"));
                PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T2Avg.getString(41))/11)+" "+setF4T2Avg.getString(43)+" "+setF4T2Avg.getString(42)));
                ...
                PdfPCell f1t3 = new PdfPCell(new Paragraph("F1T3"));
                PdfPCell f1t3m = new PdfPCell(new Paragraph(String.format("%.1f",(Float.parseFloat(setF1T3Avg.getString(30)))/11)+" "+setF1T3Avg.getString(31)));
                PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3"));
                PdfPCell f2t3m = new PdfPCell(new Paragraph(String.format("%.1f",(Float.parseFloat(setF2T3Avg.getString(30)))/11)+" "+setF2T3Avg.getString(31)));
                PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3"));
                PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T3Avg.getString(41))/11)+" "+setF3T3Avg.getString(43)+" "+setF3T3Avg.getString(42)));
                PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3"));
                PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setAvg.getString(42)+" "+setAvg.getString(43)));
                tableLastSummary.addCell(f1t3);
                tableLastSummary.addCell(f1t3m);
...
connection.close();
    ...
    private void printBioHisAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printBioHisBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printBioGeoAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printBioGeoBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printPhyCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printPhyCreBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printPhyHisAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printPhyHisBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printPhyGeoAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printPhyGeoBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
connection.close();
    ...
    private void printAllSubjects(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
            String sqlComm = "SELECT * FROM tbl_comments";
            String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
            String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
...
document.add((new Paragraph(" ")));
                ...
                PdfPCell avgD5 = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setAvg.getString(42),font));
                ...
                PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(avgAvgTotal)+" "+setAvg.getString(42)+" "+setAvg.getString(43),font));
                tableLastSummary.addCell(f1t3);
                tableLastSummary.addCell(f1t3m);
                tableLastSummary.addCell(f2t3);
                tableLastSummary.addCell(f2t3m);
