...
public class StudentUpdated implements Initializable {
    ...
    @FXML private TableColumn<tableStudentsData, Boolean> editColumn;
    ...
    public void classFilter(){
        ...
        try{
            ...
            String old = classFilter.getText();
            if (old.equals("form 1")||old.equals("form1")||old.equals("FORM 1")||old.equals("FORM1")) {
              String newVal =   classFilter.getText().replace(old, "FORM_1");
              System.out.println(newVal);
                statement.setString(1,newVal);
            }else if (old.equals("form 2")||old.equals("form2")||old.equals("FORM 2")||old.equals("FORM2")){
                String newVal =   classFilter.getText().replace(old, "FORM_2");
                System.out.println(newVal);
                statement.setString(1,newVal);
            }else if (old.equals("form 3")||old.equals("form3")||old.equals("FORM 3")||old.equals("FORM3")){
                String newVal =   classFilter.getText().replace(old, "FORM_3");
                System.out.println(newVal);
                statement.setString(1,newVal);
            }else if (old.equals("form 4")||old.equals("form4")||old.equals("FORM 4")||old.equals("FORM4")){
                String newVal =   classFilter.getText().replace(old, "FORM_4");
                System.out.println(newVal);
                statement.setString(1,newVal);
            }else{
            ...
            while (resultSet.next()){
                this.tableList.addAll(new tableStudentsData(resultSet.getString(1),resultSet.getString(2),resultSet.getString(3),resultSet.getString(4),resultSet.getString(5),resultSet.getString(6),resultSet.getString(7)));
            }

            //this.idColumn.setCellValueFactory(new PropertyValueFactory<>("id"));
            this.admColumn.setCellValueFactory(new PropertyValueFactory<>("adm"));
            ...
            this.lnameColumn.setCellValueFactory(new PropertyValueFactory<>("lname"));
            this.kcpeColumn.setCellValueFactory(new PropertyValueFactory<>("kcpe"));
            this.classColumn.setCellValueFactory(new PropertyValueFactory<>("classes"));
            ...
            this.editColumn.setCellFactory((Callback<TableColumn<tableStudentsData, Boolean>, TableCell<tableStudentsData, Boolean>>) p ->  new ButtonCellEdit());
    ...
    private class ButtonCell extends TableCell<tableStudentsData, Boolean> {
        ...
        ButtonCell(){
            cellButton.setOnAction(t -> {
                deleteStudents deleteStudents2 = new deleteStudents();

                Thread t1 = new Thread(new deleteStudents(), "t1");
                //String sql ="INSERT INTO tbl_delete";

                tableStudentsData toRemove = (tableStudentsData) tableStudents.getItems().get(getTableRow().getIndex());
                deleteStudents2.toRemove=toRemove.getAdm();
                t1.start();
    ...
    //edit button
    private class ButtonCellEdit extends TableCell<tableStudentsData, Boolean> {
        final Button cellButtonEdit = new Button("Edit");
        ButtonCellEdit(){
            cellButtonEdit.setOnAction(t -> {
                tableStudentsData toEdit = (tableStudentsData) tableStudents.getItems().get(getTableRow().getIndex());
                AddEditStudent addEditStudent = new AddEditStudent();
                addEditStudent.uAdm=toEdit.getAdm();
                addEditStudent.uFname=toEdit.getFname();
                addEditStudent.uMname=toEdit.getMname();
                addEditStudent.uLname=toEdit.getLname();
                addEditStudent.uKcpe=toEdit.getKcpe();
                addEditStudent.uClass=toEdit.getClasses();
                addEditStudent.uDob=toEdit.getDob();
                addEditStudent.edit=true;
                addEditStudent();
            });
    ...
    public void loadData(){
        ...
        try{
            ...
            while (set.next()){
                //this.tableList.addAll(new tableStudentsData(set.getString(1),set.getString(2),set.getString(3),set.getString(4),set.getString(5),set.getString(6),set.getString(7)));
                this.tableList.addAll(new tableStudentsData(set.getString(2),set.getString(3),set.getString(4),set.getString(5),set.getString(6),set.getString(7),set.getString(8)));
            }
    ...
    @FXML void addEditStudent(){
        try{
            Stage stage = new Stage();
            FXMLLoader loader = new FXMLLoader();
            Pane root = (Pane)loader.load(getClass().getResource("addEditStudent.fxml"));
            Image applicationIcon = new Image(getClass().getResourceAsStream("/icons/icon.png"));
            stage.getIcons().add(applicationIcon);

            AddEditStudent addEditStudent = (AddEditStudent) loader.getController();
            addEditStudent.edit=true;
