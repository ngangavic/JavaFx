...
public class ReportFormAverage {
    ...
    public void printAllResults(String DBTableName,String CLSName,String exam,String tbl,String form,String term){
        ...
        try {
            ...
            while (totalSet.next()) {
                ...
                document.open();
                infoBox("Printing the doc","Print",null);
                int pos = 0;
                while (studentSet.next()) {

                    pos++;
                    String adm = studentSet.getString(2);
                    infoBox("Printing the doc for"+adm,"Print",null);
                    ...
                    if (Integer.parseInt(bio) == 1 && Integer.parseInt(phy) == 1 && Integer.parseInt(geo) == 1 && Integer.parseInt(his) == 1 && Integer.parseInt(cre) == 1 && Integer.parseInt(bus) == 1 && Integer.parseInt(agri) == 1) {
                        printAllSubjects(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                    } else {
                        ...
                        if (Integer.parseInt(bio) == 0) {
                            ...
                            if (Integer.parseInt(geo) == 1) {
                                if (Integer.parseInt(bus) == 1) {
                                    ...
                                    printPhyGeoBus(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                } else {
                                    //  infoBox("You are doing physics,geography,agriculture","Subject",null);
                                    printPhyGeoAgri(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                }
                            } else if (Integer.parseInt(his) == 1) {
                                if (Integer.parseInt(bus) == 1) {
                                    //  infoBox("You are doing physics,history,business","Subject",null);
                                    printPhyHisBus(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                } else {
                                    //  infoBox("You are doing physics,history,agriculture","Subject",null);
                                    printPhyHisAgri(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                }
                            } else {
                                if (Integer.parseInt(bus) == 1) {
                                    //    infoBox("You are physics,cre,doing business","Subject",null);
                                    printPhyCreBus(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                } else {
                                    //  infoBox("You are doing physics,cre,agriculture","Subject",null);
                                    printPhyCreAgri(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                }
                            }
                            ...
                            if (Integer.parseInt(geo) == 1) {
                                if (Integer.parseInt(bus) == 1) {
                                    ...
                                    printBioGeoBus(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                } else {
                                    // infoBox("You are doing biology,geography,agriculture","Subject",null);
                                    printBioGeoAgri(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                }
                            } else if (Integer.parseInt(his) == 1) {
                                if (Integer.parseInt(bus) == 1) {
                                    //infoBox("You are doing biology,history,business","Subject",null);
                                    printBioHisBus(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                } else {
                                    //infoBox("You are doing biology,history,agriculture","Subject",null);
                                    printBioHisAgri(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                }
                            } else {
                                if (Integer.parseInt(bus) == 1) {
                                    // infoBox("You are biology,cre,doing business","Subject",null);
                                    printBioCreBus(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                } else {
                                    // infoBox("You are doing biology,cre,agriculture","Subject",null);
                                    printBioCreAgri(adm, document, writer, pos, totalStudents, exam, CLSName, tbl, form, term);
                                }
                            }
                        }
                    }}
            ...
            document.close();
                infoBox("Printing ended","Print",null);
            writer.close();
            //Desktop.getDesktop().open(new File(cname+"\\HS Results\\"+names+".pdf"));
            //Desktop.getDesktop().open(new File(cname + "\\HS Results\\" + names + ".pdf"));
                infoBox("Openning doc","Open",null);
                Desktop.getDesktop().print(new File(cname + "\\HS Results\\" + names + ".pdf"));
        }
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        ...
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
        String sqlEx2 = "SELECT * FROM "+tbl+"_ex2 WHERE adm=? ";
        String sqlEx3 = "SELECT * FROM "+tbl+"_ex3 WHERE adm=? ";
        String sqlAvg = "SELECT * FROM "+tbl+"_avg WHERE adm=? ";
        String sqlF1T1Avg = "SELECT * FROM tbl_f1_t1_"+ex+" WHERE adm=?";
        String sqlF1T2Avg = "SELECT * FROM tbl_f1_t2_"+ex+" WHERE adm=?";
        String sqlF1T3Avg = "SELECT * FROM tbl_f1_t3_"+ex+" WHERE adm=?";
        String sqlF2T1Avg = "SELECT * FROM tbl_f2_t1_"+ex+" WHERE adm=?";
        String sqlF2T2Avg = "SELECT * FROM tbl_f2_t2_"+ex+" WHERE adm=?";
        String sqlF2T3Avg = "SELECT * FROM tbl_f2_t3_"+ex+" WHERE adm=?";
        String sqlF3T1Avg = "SELECT * FROM tbl_f3_t1_"+ex+" WHERE adm=?";
        String sqlF3T2Avg = "SELECT * FROM tbl_f3_t2_"+ex+" WHERE adm=?";
        String sqlF3T3Avg = "SELECT * FROM tbl_f3_t3_"+ex+" WHERE adm=?";
        String sqlF4T1Avg = "SELECT * FROM tbl_f4_t1_"+ex+" WHERE adm=?";
        String sqlF4T2Avg = "SELECT * FROM tbl_f4_t2_"+ex+" WHERE adm=?";
        String sqlF4T3Avg = "SELECT * FROM tbl_f4_t3_"+ex+" WHERE adm=?";
        ...
        try{
            ...
            PreparedStatement statementAvgF3T3 = connection.prepareStatement(sqlF3T3Avg);
            PreparedStatement statementAvgF4T1 = connection.prepareStatement(sqlF4T1Avg);
            PreparedStatement statementAvgF4T2 = connection.prepareStatement(sqlF4T2Avg);
            PreparedStatement statementAvgF4T3 = connection.prepareStatement(sqlF4T3Avg);
            ...
            statementAvgF3T3.setString(1,adm);
            statementAvgF4T1.setString(1,adm);
            statementAvgF4T2.setString(1,adm);
            statementAvgF4T3.setString(1,adm);
            ...
            ResultSet setF3T3Avg = statementAvgF3T3.executeQuery();
            ResultSet setF4T1Avg = statementAvgF4T1.executeQuery();
            ResultSet setF4T2Avg = statementAvgF4T2.executeQuery();
            ResultSet setF4T3Avg = statementAvgF4T3.executeQuery();
...
while (set.next()) {
    ...
    document.add((new Paragraph(" ")));
            ...
            Font font2 =  new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL);
                                                                                                                            ...
                                                                                                                            PdfPCell engD2 = new PdfPCell(new Paragraph(setE1.getString(8) + " " + setE1.getString(9),font2));
                                                                                                                            PdfPCell engD3 = new PdfPCell(new Paragraph(setE2.getString(8) + " " + setE2.getString(9),font2));
                                                                                                                            PdfPCell engD4 = new PdfPCell(new Paragraph(setE3.getString(8) + " " + setE3.getString(9),font2));

                                                                                                                            int avgE = Integer.parseInt(setAvg.getString(8));
                                                                                                                            if (avgE >= Integer.parseInt(setEngGrade.getString(4))) {
                                                                                                                                com = setComments.getString(2);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(5))) {
                                                                                                                                com = setComments.getString(3);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(6))) {
                                                                                                                                com = setComments.getString(4);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(7))) {
                                                                                                                                com = setComments.getString(5);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(8))) {
                                                                                                                                com = setComments.getString(6);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(9))) {
                                                                                                                                com = setComments.getString(7);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(10))) {
                                                                                                                                com = setComments.getString(8);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(11))) {
                                                                                                                                com = setComments.getString(9);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(12))) {
                                                                                                                                com = setComments.getString(10);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(13))) {
                                                                                                                                com = setComments.getString(11);
                                                                                                                            } else if (avgE >= Integer.parseInt(setEngGrade.getString(14))) {
                                                                                                                                com = setComments.getString(12);
                                                                                                                            } else {
                                                                                                                                com = setComments.getString(13);
                                                                                                                            }
                                                                                                                            PdfPCell engD5 = new PdfPCell(new Paragraph(setAvg.getString(8) + " " + setAvg.getString(9),font2));
                                                                                                                            ...
                                                                                                                            PdfPCell kisD2 = new PdfPCell(new Paragraph(setE1.getString(11) + " " + setE1.getString(12),font2));
                                                                                                                            PdfPCell kisD3 = new PdfPCell(new Paragraph(setE2.getString(11) + " " + setE2.getString(12),font2));
                                                                                                                            PdfPCell kisD4 = new PdfPCell(new Paragraph(setE3.getString(11) + " " + setE3.getString(12),font2));

                                                                                                                            int avgKis = Integer.parseInt(setAvg.getString(11));
                                                                                                                            if (avgKis >= Integer.parseInt(setKisGrade.getString(4))) {
                                                                                                                                com = setComments.getString(2);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(5))) {
                                                                                                                                com = setComments.getString(3);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(6))) {
                                                                                                                                com = setComments.getString(4);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(7))) {
                                                                                                                                com = setComments.getString(5);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(8))) {
                                                                                                                                com = setComments.getString(6);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(9))) {
                                                                                                                                com = setComments.getString(7);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(10))) {
                                                                                                                                com = setComments.getString(8);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(11))) {
                                                                                                                                com = setComments.getString(9);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(12))) {
                                                                                                                                com = setComments.getString(10);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(13))) {
                                                                                                                                com = setComments.getString(11);
                                                                                                                            } else if (avgKis >= Integer.parseInt(setKisGrade.getString(14))) {
                                                                                                                                com = setComments.getString(12);
                                                                                                                            } else {
                                                                                                                                com = setComments.getString(13);
                                                                                                                            }
                                                                                                                            PdfPCell kisD5 = new PdfPCell(new Paragraph(setAvg.getString(11) + " " + setAvg.getString(12),font2));
                                                                                                                            ...
                                                                                                                            PdfPCell matD2 = new PdfPCell(new Paragraph(setE1.getString(14) + " " + setE1.getString(15),font2));
                                                                                                                            PdfPCell matD3 = new PdfPCell(new Paragraph(setE2.getString(14) + " " + setE2.getString(15),font2));
                                                                                                                            PdfPCell matD4 = new PdfPCell(new Paragraph(setE3.getString(14) + " " + setE3.getString(15),font2));

                                                                                                                            int avgMat = Integer.parseInt(setAvg.getString(14));
                                                                                                                            if (avgMat >= Integer.parseInt(setMatGrade.getString(4))) {
                                                                                                                                com = setComments.getString(2);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(5))) {
                                                                                                                                com = setComments.getString(3);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(6))) {
                                                                                                                                com = setComments.getString(4);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(7))) {
                                                                                                                                com = setComments.getString(5);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(8))) {
                                                                                                                                com = setComments.getString(6);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(9))) {
                                                                                                                                com = setComments.getString(7);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(10))) {
                                                                                                                                com = setComments.getString(8);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(11))) {
                                                                                                                                com = setComments.getString(9);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(12))) {
                                                                                                                                com = setComments.getString(10);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(13))) {
                                                                                                                                com = setComments.getString(11);
                                                                                                                            } else if (avgMat >= Integer.parseInt(setMatGrade.getString(14))) {
                                                                                                                                com = setComments.getString(12);
                                                                                                                            } else {
                                                                                                                                com = setComments.getString(13);
                                                                                                                            }

                                                                                                                            PdfPCell matD5 = new PdfPCell(new Paragraph(setAvg.getString(14) + " " + setAvg.getString(15),font2));
                                                                                                                            ...
                                                                                                                            PdfPCell chemD2 = new PdfPCell(new Paragraph(setE1.getString(20) + " " + setE1.getString(21),font2));
                                                                                                                            PdfPCell chemD3 = new PdfPCell(new Paragraph(setE2.getString(20) + " " + setE2.getString(21),font2));
                                                                                                                            PdfPCell chemD4 = new PdfPCell(new Paragraph(setE3.getString(20) + " " + setE3.getString(21),font2));

                                                                                                                            int avgChem = Integer.parseInt(setAvg.getString(20));
                                                                                                                            if (avgChem >= Integer.parseInt(setChemGrade.getString(4))) {
                                                                                                                                com = setComments.getString(2);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(5))) {
                                                                                                                                com = setComments.getString(3);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(6))) {
                                                                                                                                com = setComments.getString(4);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(7))) {
                                                                                                                                com = setComments.getString(5);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(8))) {
                                                                                                                                com = setComments.getString(6);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(9))) {
                                                                                                                                com = setComments.getString(7);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(10))) {
                                                                                                                                com = setComments.getString(8);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(11))) {
                                                                                                                                com = setComments.getString(9);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(12))) {
                                                                                                                                com = setComments.getString(10);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(13))) {
                                                                                                                                com = setComments.getString(11);
                                                                                                                            } else if (avgChem >= Integer.parseInt(setChemGrade.getString(14))) {
                                                                                                                                com = setComments.getString(12);
                                                                                                                            } else {
                                                                                                                                com = setComments.getString(13);
                                                                                                                            }

                                                                                                                            PdfPCell chemD5 = new PdfPCell(new Paragraph(setAvg.getString(20) + " " + setAvg.getString(21),font2));
                                                                                                                            ...
                                                                                                                            PdfPCell bioD2 = new PdfPCell(new Paragraph(setE1.getString(17) + " " + setE1.getString(18),font2));
                                                                                                                            PdfPCell bioD3 = new PdfPCell(new Paragraph(setE2.getString(17) + " " + setE2.getString(18),font2));
                                                                                                                            PdfPCell bioD4 = new PdfPCell(new Paragraph(setE3.getString(17) + " " + setE3.getString(18),font2));

                                                                                                                            int avgBio = Integer.parseInt(setAvg.getString(17));
                                                                                                                            if (avgBio >= Integer.parseInt(setBioGrade.getString(4))) {
                                                                                                                                com = setComments.getString(2);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(5))) {
                                                                                                                                com = setComments.getString(3);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(6))) {
                                                                                                                                com = setComments.getString(4);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(7))) {
                                                                                                                                com = setComments.getString(5);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(8))) {
                                                                                                                                com = setComments.getString(6);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(9))) {
                                                                                                                                com = setComments.getString(7);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(10))) {
                                                                                                                                com = setComments.getString(8);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(11))) {
                                                                                                                                com = setComments.getString(9);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(12))) {
                                                                                                                                com = setComments.getString(10);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(13))) {
                                                                                                                                com = setComments.getString(11);
                                                                                                                            } else if (avgBio >= Integer.parseInt(setBioGrade.getString(14))) {
                                                                                                                                com = setComments.getString(12);
                                                                                                                            } else {
                                                                                                                                com = setComments.getString(13);
                                                                                                                            }

                                                                                                                            PdfPCell bioD5 = new PdfPCell(new Paragraph(setAvg.getString(17) + " " + setAvg.getString(18),font2));
                                                                                                                            ...
                                                                                                                            PdfPCell creD2 = new PdfPCell(new Paragraph(setE1.getString(32) + " " + setE1.getString(33),font2));
                                                                                                                            PdfPCell creD3 = new PdfPCell(new Paragraph(setE2.getString(32) + " " + setE2.getString(33),font2));
                                                                                                                            PdfPCell creD4 = new PdfPCell(new Paragraph(setE3.getString(32) + " " + setE3.getString(33),font2));

                                                                                                                            int avgCre = Integer.parseInt(setAvg.getString(32));
                                                                                                                            if (avgCre >= Integer.parseInt(setCreGrade.getString(4))) {
                                                                                                                                com = setComments.getString(2);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(5))) {
                                                                                                                                com = setComments.getString(3);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(6))) {
                                                                                                                                com = setComments.getString(4);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(7))) {
                                                                                                                                com = setComments.getString(5);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(8))) {
                                                                                                                                com = setComments.getString(6);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(9))) {
                                                                                                                                com = setComments.getString(7);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(10))) {
                                                                                                                                com = setComments.getString(8);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(11))) {
                                                                                                                                com = setComments.getString(9);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(12))) {
                                                                                                                                com = setComments.getString(10);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(13))) {
                                                                                                                                com = setComments.getString(11);
                                                                                                                            } else if (avgCre >= Integer.parseInt(setCreGrade.getString(14))) {
                                                                                                                                com = setComments.getString(12);
                                                                                                                            } else {
                                                                                                                                com = setComments.getString(13);
                                                                                                                            }

                                                                                                                            PdfPCell creD5 = new PdfPCell(new Paragraph(setAvg.getString(32) + " " + setAvg.getString(33),font2));
                                                                                                                            ...
                                                                                                                            PdfPCell agriD2 = new PdfPCell(new Paragraph(setE1.getString(38) + " " + setE1.getString(39),font2));
                                                                                                                            PdfPCell agriD3 = new PdfPCell(new Paragraph(setE2.getString(38) + " " + setE2.getString(39),font2));
                                                                                                                            PdfPCell agriD4 = new PdfPCell(new Paragraph(setE3.getString(38) + " " + setE3.getString(39),font2));

                                                                                                                            int avgAgri = Integer.parseInt(setAvg.getString(38));
                                                                                                                            if (avgAgri >= Integer.parseInt(setAgriGrade.getString(4))) {
                                                                                                                                com = setComments.getString(2);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(5))) {
                                                                                                                                com = setComments.getString(3);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(6))) {
                                                                                                                                com = setComments.getString(4);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(7))) {
                                                                                                                                com = setComments.getString(5);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(8))) {
                                                                                                                                com = setComments.getString(6);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(9))) {
                                                                                                                                com = setComments.getString(7);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(10))) {
                                                                                                                                com = setComments.getString(8);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(11))) {
                                                                                                                                com = setComments.getString(9);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(12))) {
                                                                                                                                com = setComments.getString(10);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(13))) {
                                                                                                                                com = setComments.getString(11);
                                                                                                                            } else if (avgAgri >= Integer.parseInt(setAgriGrade.getString(14))) {
                                                                                                                                com = setComments.getString(12);
                                                                                                                            } else {
                                                                                                                                com = setComments.getString(13);
                                                                                                                            }

                                                                                                                            PdfPCell agriD5 = new PdfPCell(new Paragraph(setAvg.getString(38) + " " + setAvg.getString(39),font2));
                                                                                                                            ...
                                                                                                                            PdfPCell totalD2 = new PdfPCell(new Paragraph(String.valueOf(totalE1),font2));
                                                                                                                            PdfPCell totalD3 = new PdfPCell(new Paragraph(String.valueOf(totalE2),font2));
                                                                                                                            PdfPCell totalD4 = new PdfPCell(new Paragraph(String.valueOf(totalE3),font2));
                                                                                                                            PdfPCell totalD5 = new PdfPCell(new Paragraph(String.valueOf(totalAvg),font2));
                                                                                                                            ...
                                                                                                                            if (addAvgEx1 >= Integer.parseInt(setTotal.getString(4))) {
                                                                                                                                g = "A";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(5))) {
                                                                                                                                g = "A-";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(6))) {
                                                                                                                                g = "B+";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(7))) {
                                                                                                                                g = "B";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(8))) {
                                                                                                                                g = "B-";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(9))) {
                                                                                                                                g = "C+";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(10))) {
                                                                                                                                g = "C";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(11))) {
                                                                                                                                g = "C-";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(12))) {
                                                                                                                                g = "D+";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(13))) {
                                                                                                                                g = "D";
                                                                                                                            } else if (addAvgEx1 >= Integer.parseInt(setTotal.getString(14))) {
                                                                                                                                g = "D-";
                                                                                                                            } else {
                                                                                                                                g = "E";
                                                                                                                            }
                                                                                                                            PdfPCell avgD1 = new PdfPCell(new Paragraph("Average",font));
                                                                                                                            PdfPCell avgD2 = new PdfPCell(new Paragraph(String.valueOf(addAvgEx1) + " " + setE1.getString(42),font2));
                                                                                                                            if (addAvgEx2 >= Integer.parseInt(setTotal.getString(4))) {
                                                                                                                                g = "A";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(5))) {
                                                                                                                                g = "A-";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(6))) {
                                                                                                                                g = "B+";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(7))) {
                                                                                                                                g = "B";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(8))) {
                                                                                                                                g = "B-";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(9))) {
                                                                                                                                g = "C+";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(10))) {
                                                                                                                                g = "C";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(11))) {
                                                                                                                                g = "C-";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(12))) {
                                                                                                                                g = "D+";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(13))) {
                                                                                                                                g = "D";
                                                                                                                            } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(14))) {
                                                                                                                                g = "D-";
                                                                                                                            } else {
                                                                                                                                g = "E";
                                                                                                                            }
                                                                                                                            ...
                                                                                                                            if (addAvgEx3 >= Integer.parseInt(setTotal.getString(4))) {
                                                                                                                                g = "A";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(5))) {
                                                                                                                                g = "A-";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(6))) {
                                                                                                                                g = "B+";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(7))) {
                                                                                                                                g = "B";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(8))) {
                                                                                                                                g = "B-";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(9))) {
                                                                                                                                g = "C+";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(10))) {
                                                                                                                                g = "C";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(11))) {
                                                                                                                                g = "C-";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(12))) {
                                                                                                                                g = "D+";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(13))) {
                                                                                                                                g = "D";
                                                                                                                            } else if (addAvgEx3 >= Integer.parseInt(setTotal.getString(14))) {
                                                                                                                                g = "D-";
                                                                                                                            } else {
                                                                                                                                g = "E";
                                                                                                                            }
                                                                                                                            PdfPCell avgD4 = new PdfPCell(new Paragraph(String.valueOf(addAvgEx3) + " " + setE3.getString(42),font2));

                                                                                                                            //float avgAvgTotal = (addAvgEx1+addAvgEx2+addAvgEx3)/3;
                                                                                                                            int avgAvgTotal = Integer.parseInt(setAvg.getString(41)) / 7;

                                                                                                                            if (avgAvgTotal >= Integer.parseInt(setTotal.getString(4))) {
                                                                                                                                g = "A";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(5))) {
                                                                                                                                g = "A-";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(6))) {
                                                                                                                                g = "B+";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(7))) {
                                                                                                                                g = "B";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(8))) {
                                                                                                                                g = "B-";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(9))) {
                                                                                                                                g = "C+";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(10))) {
                                                                                                                                g = "C";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(11))) {
                                                                                                                                g = "C-";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(12))) {
                                                                                                                                g = "D+";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(13))) {
                                                                                                                                g = "D";
                                                                                                                            } else if (avgAvgTotal >= Integer.parseInt(setTotal.getString(14))) {
                                                                                                                                g = "D-";
                                                                                                                            } else {
                                                                                                                                g = "E";
                                                                                                                            }

                                                                                                                            PdfPCell avgD5 = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setAvg.getString(41)) / 7) + " " + setAvg.getString(42),font2));
            ...
            while (setF1T1Avg.next()){
                while (setF1T2Avg.next()){
                    while (setF1T3Avg.next()){
                        while (setF2T1Avg.next()) {
                            while (setF2T2Avg.next()){
                                while (setF2T3Avg.next()){
                                    while (setF3T1Avg.next()){
                                        while (setF3T2Avg.next()) {
                                            while (setF3T3Avg.next()){
                                                while (setF4T1Avg.next()){
                                                    while (setF4T2Avg.next()){
                                                        while (setF4T3Avg.next()) {
           ...
           Font font2 = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD);
            Font font = new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL);
                                                            ...
                                                            PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T1Avg.getString(41))) / 7) + " " + setF1T1Avg.getString(43) + " " + setF1T1Avg.getString(42),font));
                                                            PdfPCell f2t1 = new PdfPCell(new Paragraph("F2T1",font2));
                                                            PdfPCell f2t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T1Avg.getString(41))) / 7) + " " + setF2T1Avg.getString(43) + " " + setF2T1Avg.getString(42),font));
                                                            PdfPCell f3t1 = new PdfPCell(new Paragraph("F3T1",font2));
                                                            PdfPCell f3t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T1Avg.getString(41)) / 7) + " " + setF3T1Avg.getString(43) + " " + setF3T1Avg.getString(42),font));
                                                            PdfPCell f4t1 = new PdfPCell(new Paragraph("F4T1",font2));
                                                            PdfPCell f4t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T1Avg.getString(41)) / 7) + " " + setF4T1Avg.getString(43) + " " + setF4T1Avg.getString(42),font));tableLastSummary.addCell(f1t1);
                                                            ...
                                                            PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T2Avg.getString(41))) / 7) + " " + setF1T2Avg.getString(43) + " " + setF1T2Avg.getString(42),font));
                                                            PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2",font2));
                                                            PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T2Avg.getString(41))) / 7) + " " + setF2T2Avg.getString(43) + " " + setF2T2Avg.getString(42),font));
                                                            PdfPCell f3t2 = new PdfPCell(new Paragraph("F3T2",font2));
                                                            PdfPCell f3t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T2Avg.getString(41)) / 7) + " " + setF3T2Avg.getString(43) + " " + setF3T2Avg.getString(42),font));
                                                            PdfPCell f4t2 = new PdfPCell(new Paragraph("F4T2",font2));
                                                            PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T2Avg.getString(41)) / 7) + " " + setF4T2Avg.getString(43) + " " + setF4T2Avg.getString(42),font));tableLastSummary.addCell(f1t2);
                                                            ...
                                                            PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3Avg.getString(41))) / 7) + " " + setF1T3Avg.getString(43) + " " + setF1T3Avg.getString(42)));
                                                            PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3"));
                                                            PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T3Avg.getString(41))) / 7) + " " + setF2T3Avg.getString(43) + " " + setF2T3Avg.getString(42)));
                                                            PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3"));
                                                            PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF3T3Avg.getString(41))) / 7) + " " + setF3T3Avg.getString(43) + " " + setF3T3Avg.getString(42)));
                                                            PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3"));
                                                            PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF4T3Avg.getString(41))) / 7) + " " + setF4T3Avg.getString(43) + " " + setF4T3Avg.getString(42)));
                                                            ...
                                                            dataSet.setValue(Float.parseFloat(setF1T1Avg.getString(43)), "Marks", "F1T1");
                                                            dataSet.setValue(Float.parseFloat(setF1T2Avg.getString(43)), "Marks", "F1T2");
                                                            dataSet.setValue(Float.parseFloat(setF1T3Avg.getString(43)), "Marks", "F1T3");
                                                            dataSet.setValue(Float.parseFloat(setF2T1Avg.getString(43)), "Marks", "F2T1");
                                                            dataSet.setValue(Float.parseFloat(setF2T2Avg.getString(43)), "Marks", "F2T2");
                                                            dataSet.setValue(Float.parseFloat(setF2T3Avg.getString(43)), "Marks", "F2T3");
                                                            ...
                                                            dataSet.setValue(Float.parseFloat(setF3T3Avg.getString(43)), "Marks", "F3T3");
                                                            dataSet.setValue(Float.parseFloat(setF4T1Avg.getString(43)), "Marks", "F4T1");
                                                            dataSet.setValue(Float.parseFloat(setF4T2Avg.getString(43)), "Marks", "F4T2");
                                                            dataSet.setValue(Float.parseFloat(setF4T3Avg.getString(43)), "Marks", "F4T3");
    ...
    private void printBioCreBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell busD2 = new PdfPCell(new Paragraph(setE1.getString(35)+" "+setE1.getString(36),font2));
            PdfPCell busD3 = new PdfPCell(new Paragraph(setE2.getString(35)+" "+setE2.getString(36),font2));
            PdfPCell busD4 = new PdfPCell(new Paragraph(setE3.getString(35)+" "+setE3.getString(36),font2));
            ...
            PdfPCell busD5 = new PdfPCell(new Paragraph(setAvg.getString(35)+" "+setAvg.getString(36),font2));
            ...
            PdfPCell avgD5 = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setAvg.getString(41)) / 7)+" "+setAvg.getString(42),font2));PdfPCell avgD6 = new PdfPCell(new Paragraph(""));
            PdfPCell avgD7 = new PdfPCell(new Paragraph(""));
            table.addCell(avgD1);
            table.addCell(avgD2);
            table.addCell(avgD3);
           ...
           Font font2 = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD);
            Font font = new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL);
                                                            ...
                                                            PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3Avg.getString(41))) / 7) + " " + setF1T3Avg.getString(43) + " " + setF1T3Avg.getString(42),font));
                                                            PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3",font2));
                                                            PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T3Avg.getString(41))) / 7) + " " + setF2T3Avg.getString(43) + " " + setF2T3Avg.getString(42),font));
                                                            PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3",font2));
                                                            PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T3Avg.getString(41)) / 7) + " " + setF3T3Avg.getString(43) + " " + setF3T3Avg.getString(42),font));
                                                            PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3",font2));
                                                            PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T3Avg.getString(41)) / 7) + " " + setF4T3Avg.getString(43) + " " + setF4T3Avg.getString(42),font));
                                                            tableLastSummary.addCell(f1t3);
                                                            tableLastSummary.addCell(f1t3m);
                                                            tableLastSummary.addCell(f2t3);
                                                            tableLastSummary.addCell(f2t3m);
    ...
    private void printBioHisAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell hisD2 = new PdfPCell(new Paragraph(setE1.getString(29)+" "+setE1.getString(30),font2));
            PdfPCell hisD3 = new PdfPCell(new Paragraph(setE2.getString(29)+" "+setE2.getString(30),font2));
            PdfPCell hisD4 = new PdfPCell(new Paragraph(setE3.getString(29)+" "+setE3.getString(30),font2));
            ...
            PdfPCell hisD5 = new PdfPCell(new Paragraph(setAvg.getString(29)+" "+setAvg.getString(30),font2));
           ...
           Font font2 = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD);
            Font font = new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL);
                                                            ...
                                                            PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF3T3Avg.getString(41))) / 7) + " " + setF3T3Avg.getString(43) + " " + setF3T3Avg.getString(42),font));
                                                            PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3",font2));
                                                            PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T3Avg.getString(41)) / 7) + " " + setF4T3Avg.getString(43) + " " + setF4T3Avg.getString(42),font));tableLastSummary.addCell(f1t3);
                                                            tableLastSummary.addCell(f1t3m);
                                                            tableLastSummary.addCell(f2t3);
                                                            tableLastSummary.addCell(f2t3m);
                                                            tableLastSummary.addCell(f3t3);
    ...
    private void printBioHisBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    private void printBioGeoAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell geoD2 = new PdfPCell(new Paragraph(setE1.getString(26)+" "+setE1.getString(27),font2));
            PdfPCell geoD3 = new PdfPCell(new Paragraph(setE2.getString(26)+" "+setE2.getString(27),font2));
            PdfPCell geoD4 = new PdfPCell(new Paragraph(setE3.getString(26)+" "+setE3.getString(27),font2));
            ...
            PdfPCell geoD5 = new PdfPCell(new Paragraph(setAvg.getString(26)+" "+setAvg.getString(27),font2));
    ...
    private void printBioGeoBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    private void printPhyCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell phyD2 = new PdfPCell(new Paragraph(setE1.getString(23)+" "+setE1.getString(24),font2));
            PdfPCell phyD3 = new PdfPCell(new Paragraph(setE2.getString(23)+" "+setE2.getString(24),font2));
            PdfPCell phyD4 = new PdfPCell(new Paragraph(setE3.getString(23)+" "+setE3.getString(24),font2));
            ...
            PdfPCell phyD5 = new PdfPCell(new Paragraph(setAvg.getString(23)+" "+setAvg.getString(24),font2));
    ...
    private void printPhyCreBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    private void printPhyHisAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    private void printPhyHisBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    private void printPhyGeoAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    private void printPhyGeoBus(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
    ...
    private void printAllSubjects(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String tbl,String form,String term) {
        String sqlDetails="SELECT * FROM tbl_students WHERE adm=?";
        String sqlComm = "SELECT * FROM tbl_comments";
        String sqlTotal ="SELECT * FROM tbl_grades WHERE class='"+cls+"' AND subject='TOTAL'";
        String sqlEx1 = "SELECT * FROM "+tbl+"_ex1 WHERE adm=? ";
        ...
        String sqlF4T2Avg = "SELECT * FROM tbl_f4_t2_"+ex+" WHERE adm=?";
        String sqlF4T3Avg = "SELECT * FROM tbl_f4_t3_"+ex+" WHERE adm=?";
        //String sqlInnerJoin = "SELECT pt.tbl_f1_t1_"+ex+",pt.tbl_f1_t2_"+ex+",pt.tbl_f1_t3_"+ex+",pt.tbl_f2_t1_"+ex+",pt.tbl_f2_t2_"+ex+",pt.tbl_f2_t3_"+ex+",pt.tbl_f3_t1_"+ex+",pt.tbl_f3_t2_"+ex+",pt.tbl_f3_t3_"+ex+",pt.tbl_f4_t1_"+ex+",pt.tbl_f4_t2_"+ex+",pt.tbl_f4_t3_"+ex+" " ;
        String sqlUnion = "SELECT pt FROM tbl_f1_t1_"+ex+" WHERE adm=? UNION SELECT pt FROM tbl_f1_t2_"+ex+" WHERE adm=? UNION SELECT pt FROM tbl_f1_t3_"+ex+" WHERE adm=?" +
                "UNION SELECT pt FROM tbl_f2_t1_"+ex+" WHERE adm=? UNION SELECT pt FROM tbl_f2_t2_"+ex+" WHERE adm=? UNION SELECT pt FROM tbl_f2_t3_"+ex+" WHERE adm=?" +
                "UNION SELECT pt FROM tbl_f3_t1_"+ex+" WHERE adm=? UNION SELECT pt FROM tbl_f3_t2_"+ex+" WHERE adm=? UNION SELECT pt FROM tbl_f3_t3_"+ex+" WHERE adm=? " +
                "UNION SELECT pt FROM tbl_f4_t1_"+ex+" WHERE adm=? UNION SELECT pt FROM tbl_f4_t2_"+ex+" WHERE adm=? UNION SELECT pt FROM tbl_f4_t3_"+ex+" WHERE adm=?";
/*String sqlUnion = "SELECT pt,adm FROM tbl_f1_t1_"+ex+" WHERE adm=? UNION SELECT pt,adm FROM tbl_f1_t2_"+ex+" WHERE adm=? UNION SELECT pt,adm FROM tbl_f1_t3_"+ex+" WHERE adm=?" +
                "UNION SELECT pt,adm FROM tbl_f2_t1_"+ex+" WHERE adm=? UNION SELECT pt,adm FROM tbl_f2_t2_"+ex+" WHERE adm=? UNION SELECT pt,adm FROM tbl_f2_t3_"+ex+" WHERE adm=?" +
                "UNION SELECT pt,adm FROM tbl_f3_t1_"+ex+" WHERE adm=? UNION SELECT pt,adm FROM tbl_f3_t2_"+ex+" WHERE adm=? UNION SELECT pt,adm FROM tbl_f3_t3_"+ex+" WHERE adm=? " +
                "UNION SELECT pt,adm FROM tbl_f4_t1_"+ex+" WHERE adm=? UNION SELECT pt,adm FROM tbl_f4_t2_"+ex+" WHERE adm=? UNION SELECT pt,adm FROM tbl_f4_t3_"+ex+" WHERE adm=?";*/
        ...
        try{
            ...
            PreparedStatement statementUnion  = connection.prepareStatement(sqlUnion);
            statementUnion.setString(1,adm);
            statementUnion.setString(2,adm);
            statementUnion.setString(3,adm);
            statementUnion.setString(4,adm);
            statementUnion.setString(5,adm);
            statementUnion.setString(6,adm);
            statementUnion.setString(7,adm);
            statementUnion.setString(8,adm);
            statementUnion.setString(9,adm);
            statementUnion.setString(10,adm);
            statementUnion.setString(11,adm);
            statementUnion.setString(12,adm);
            ResultSet setUnion = statementUnion.executeQuery();
           /* while (setUnion.next()){
                System.out.println(setUnion.getString(1) + " " + setUnion.getString(2));
            }*/
            ...
            while (set.next()) {
                ...
                //adm
                Paragraph admText = new Paragraph("Adm: "+set.getString(2)+"                          Name: "+set.getString(3)+" "+set.getString(4)+" "+set.getString(5)+"          Term: "+term+"          Year: "+now.get(Calendar.YEAR),fontBold);
                Paragraph nameText = new Paragraph("Class: "+form+"                 Postion: "+String.valueOf(pos)+" "+"out of "+totalStudents+"         K.C.P.E: "+set.getString(6),fontBold);
                //Paragraph kcpeText = new Paragraph("K.C.P.E: "+set.getString(6),fontBold);
                document.add(admText);
                document.add(nameText);
                //document.add(kcpeText);
                document.add((new Paragraph(" ")));
            ...
            Font font2 =  new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD);
                                                                                                                                                    ...
                                                                                                                                                    int avgPhy = Integer.parseInt(setAvg.getString(23));
                                                                                                                                                    if (avgPhy >= Integer.parseInt(setPhyGrade.getString(4))) {
                                                                                                                                                        com = setComments.getString(2);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(5))) {
                                                                                                                                                        com = setComments.getString(3);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(6))) {
                                                                                                                                                        com = setComments.getString(4);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(7))) {
                                                                                                                                                        com = setComments.getString(5);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(8))) {
                                                                                                                                                        com = setComments.getString(6);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(9))) {
                                                                                                                                                        com = setComments.getString(7);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(10))) {
                                                                                                                                                        com = setComments.getString(8);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(11))) {
                                                                                                                                                        com = setComments.getString(9);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(12))) {
                                                                                                                                                        com = setComments.getString(10);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(13))) {
                                                                                                                                                        com = setComments.getString(11);
                                                                                                                                                    } else if (avgPhy >= Integer.parseInt(setPhyGrade.getString(14))) {
                                                                                                                                                        com = setComments.getString(12);
                                                                                                                                                    } else {
                                                                                                                                                        com = setComments.getString(13);
                                                                                                                                                    }
                                                                                                                                                    ...
                                                                                                                                                    int avgHis = Integer.parseInt(setAvg.getString(29));
                                                                                                                                                    if (avgHis >= Integer.parseInt(setHisGrade.getString(4))) {
                                                                                                                                                        com = setComments.getString(2);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(5))) {
                                                                                                                                                        com = setComments.getString(3);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(6))) {
                                                                                                                                                        com = setComments.getString(4);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(7))) {
                                                                                                                                                        com = setComments.getString(5);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(8))) {
                                                                                                                                                        com = setComments.getString(6);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(9))) {
                                                                                                                                                        com = setComments.getString(7);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(10))) {
                                                                                                                                                        com = setComments.getString(8);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(11))) {
                                                                                                                                                        com = setComments.getString(9);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(12))) {
                                                                                                                                                        com = setComments.getString(10);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(13))) {
                                                                                                                                                        com = setComments.getString(11);
                                                                                                                                                    } else if (avgHis >= Integer.parseInt(setHisGrade.getString(14))) {
                                                                                                                                                        com = setComments.getString(12);
                                                                                                                                                    } else {
                                                                                                                                                        com = setComments.getString(13);
                                                                                                                                                    }
                                                                                                                                                    ...
                                                                                                                                                    int avgGeo = Integer.parseInt(setAvg.getString(26));
                                                                                                                                                    if (avgGeo >= Integer.parseInt(setGeoGrade.getString(4))) {
                                                                                                                                                        com = setComments.getString(2);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(5))) {
                                                                                                                                                        com = setComments.getString(3);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(6))) {
                                                                                                                                                        com = setComments.getString(4);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(7))) {
                                                                                                                                                        com = setComments.getString(5);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(8))) {
                                                                                                                                                        com = setComments.getString(6);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(9))) {
                                                                                                                                                        com = setComments.getString(7);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(10))) {
                                                                                                                                                        com = setComments.getString(8);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(11))) {
                                                                                                                                                        com = setComments.getString(9);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(12))) {
                                                                                                                                                        com = setComments.getString(10);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(13))) {
                                                                                                                                                        com = setComments.getString(11);
                                                                                                                                                    } else if (avgGeo >= Integer.parseInt(setGeoGrade.getString(14))) {
                                                                                                                                                        com = setComments.getString(12);
                                                                                                                                                    } else {
                                                                                                                                                        com = setComments.getString(13);
                                                                                                                                                    }
                                                                                                                                                    ...
                                                                                                                                                    int avgBus = Integer.parseInt(setAvg.getString(35));
                                                                                                                                                    if (avgBus >= Integer.parseInt(setBusGrade.getString(4))) {
                                                                                                                                                        com = setComments.getString(2);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(5))) {
                                                                                                                                                        com = setComments.getString(3);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(6))) {
                                                                                                                                                        com = setComments.getString(4);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(7))) {
                                                                                                                                                        com = setComments.getString(5);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(8))) {
                                                                                                                                                        com = setComments.getString(6);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(9))) {
                                                                                                                                                        com = setComments.getString(7);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(10))) {
                                                                                                                                                        com = setComments.getString(8);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(11))) {
                                                                                                                                                        com = setComments.getString(9);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(12))) {
                                                                                                                                                        com = setComments.getString(10);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(13))) {
                                                                                                                                                        com = setComments.getString(11);
                                                                                                                                                    } else if (avgBus >= Integer.parseInt(setBusGrade.getString(14))) {
                                                                                                                                                        com = setComments.getString(12);
                                                                                                                                                    } else {
                                                                                                                                                        com = setComments.getString(13);
                                                                                                                                                    }
                                                                                                                                                    ...
                                                                                                                                                    PdfPCell avgD2 = new PdfPCell(new Paragraph(String.valueOf(addAvgEx1) + " " + setE1.getString(42), font));
                                                                                                                                                    if (addAvgEx2 >= Integer.parseInt(setTotal.getString(4))) {
                                                                                                                                                        g = "A";
                                                                                                                                                    } else if (addAvgEx2 >= Integer.parseInt(setTotal.getString(5))) {
                                                                                                                                                        g = "A-";
                                                                                                                                                    ...
                                                                                                                                                    PdfPCell avgD5 = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setAvg.getString(41)) / 11) + " " + setAvg.getString(42), font));
           ...
           Font font2 = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD);
            Font font = new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL);
                ...
                PdfPCell f1t1 = new PdfPCell(new Paragraph("F1T1", font2));
                PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF1T1Avg.getString(41)) / 11) + " " + setF1T1Avg.getString(43) + " " + setF1T1Avg.getString(42), font));
                PdfPCell f2t1 = new PdfPCell(new Paragraph("F2T1", font2));
                PdfPCell f2t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF2T1Avg.getString(41)) / 11) + " " + setF2T1Avg.getString(43) + " " + setF2T1Avg.getString(42), font));
                PdfPCell f3t1 = new PdfPCell(new Paragraph("F3T1", font2));
                ...
                PdfPCell f4t1 = new PdfPCell(new Paragraph("F4T1", font2));
                PdfPCell f4t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T1Avg.getString(41)) / 11) + " " + setF4T1Avg.getString(43) + " " + setF4T1Avg.getString(42), font));
                ...
                tableLastSummary.addCell(f4t1m);
                                ...
                                PdfPCell f1t2 = new PdfPCell(new Paragraph("F1T2", font2));
                                PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF1T2Avg.getString(41)) / 11) + " " + setF1T2Avg.getString(43) + " " + setF1T2Avg.getString(42), font));
                                PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2", font2));
                                PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF2T2Avg.getString(41)) / 11) + " " + setF2T2Avg.getString(43) + " " + setF2T2Avg.getString(42), font));
                                PdfPCell f3t2 = new PdfPCell(new Paragraph("F3T2", font2));
                                ...
                                PdfPCell f4t2 = new PdfPCell(new Paragraph("F4T2", font2));
                                PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T2Avg.getString(41)) / 11) + " " + setF4T2Avg.getString(43) + " " + setF4T2Avg.getString(42), font));
                                ...
                                PdfPCell f1t3 = new PdfPCell(new Paragraph("F1T3", font2));
                                PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF1T3Avg.getString(41)) / 11) + " " + setF1T3Avg.getString(43) + " " + setF1T3Avg.getString(42), font));
                                PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3", font2));
                                PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf(Float.parseFloat(setF2T3Avg.getString(41)) / 11) + " " + setF2T3Avg.getString(43) + " " + setF2T3Avg.getString(42), font));
                                PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3", font2));
                                PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T3Avg.getString(41)) / 11) + " " + setF3T3Avg.getString(43) + " " + setF3T3Avg.getString(42), font));
                                PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3", font2));
                                PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T3Avg.getString(41)) / 11) + " " + setF4T3Avg.getString(43) + " " + setF4T3Avg.getString(42), font));
                                tableLastSummary.addCell(f1t3);
                                tableLastSummary.addCell(f1t3m);
                                tableLastSummary.addCell(f2t3);
                                tableLastSummary.addCell(f2t3m);
                ...
                chart.draw(graphics2d, rectangle2d);
                graphics2d.dispose();
                contentByte.addTemplate(template, 30, 268);
        }}}}}}}}}}}}
