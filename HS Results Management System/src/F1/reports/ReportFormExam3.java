...
public class ReportFormExam3 {
    ...
    private void printBioCreAgri(String adm, Document document, PdfWriter writer, int pos, String totalStudents,String ex,String cls,String currentTbl,String form,String term) {
        ...
        String sqlEx3 = "SELECT * FROM "+currentTbl+" WHERE adm=? ";
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell engD5 = new PdfPCell(new Paragraph(setE3.getString(8)+" "+setE3.getString(9),font2));
            ...
            if (avgKis >= Integer.parseInt(setKisGrade.getString(4))) {com = setComments.getString(2); } else if (avgKis >= Integer.parseInt(setKisGrade.getString(5))) { com = setComments.getString(3); }else if (avgKis >=Integer.parseInt(setKisGrade.getString(6))){ com = setComments.getString(4);}else if (avgKis >=Integer.parseInt(setKisGrade.getString(7))){
                ...
                com = setComments.getString(12);}else {com = setComments.getString(13); }
            PdfPCell kisD5 = new PdfPCell(new Paragraph(setE3.getString(11)+" "+setE3.getString(12),font2));
            ...
            PdfPCell matD5 = new PdfPCell(new Paragraph(setE3.getString(14)+" "+setE3.getString(15),font2));
            ...
            PdfPCell chemD5 = new PdfPCell(new Paragraph(setE3.getString(20)+" "+setE3.getString(21),font2));
            ...
            PdfPCell bioD5 = new PdfPCell(new Paragraph(setE3.getString(17)+" "+setE3.getString(18),font2));
            ...
            PdfPCell creD5 = new PdfPCell(new Paragraph(setE3.getString(32)+" "+setE3.getString(33),font2));
            ...
            PdfPCell agriD5 = new PdfPCell(new Paragraph(setE3.getString(38)+" "+setE3.getString(39),font2));
            ...
            PdfPCell avgD5 = new PdfPCell(new Paragraph(String.valueOf(Math.round(avgAvgTotal))+" "+setE3.getString(42),font2));
           ...
           Font font2 = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD);
            ...
            PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T1E3.getString(41)))/7)+" "+setF1T1E3.getString(43)+" "+setF1T1E3.getString(42),font));
            PdfPCell f2t1 = new PdfPCell(new Paragraph("F2T1",font2));
            PdfPCell f2t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T1E3.getString(41)))/7)+" "+setF2T1E3.getString(43)+" "+setF2T1E3.getString(42),font));
            PdfPCell f3t1 = new PdfPCell(new Paragraph("F3T1",font2));
            PdfPCell f3t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T1E3.getString(41))/7)+" "+setF3T1E3.getString(43)+" "+setF3T1E3.getString(42),font));
            PdfPCell f4t1 = new PdfPCell(new Paragraph("F4T1",font2));
            PdfPCell f4t1m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T1E3.getString(41))/7)+" "+setF4T1E3.getString(43)+" "+setF4T1E3.getString(42),font));tableLastSummary.addCell(f1t1);tableLastSummary.addCell(f1t1m);
            ...
            PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T2E3.getString(41)))/7)+" "+setF1T2E3.getString(43)+" "+setF1T2E3.getString(42),font));
            PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2",font2));
            PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T2E3.getString(41)))/7)+" "+setF2T2E3.getString(43)+" "+setF2T2E3.getString(42),font));
            PdfPCell f3t2 = new PdfPCell(new Paragraph("F3T2",font2));
            PdfPCell f3t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T2E3.getString(41))/7)+" "+setF3T2E3.getString(43)+" "+setF3T2E3.getString(42),font));
            PdfPCell f4t2 = new PdfPCell(new Paragraph("F4T2",font2));
            PdfPCell f4t2m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T2E3.getString(41))/7)+" "+setF4T2E3.getString(43)+" "+setF4T2E3.getString(42),font));tableLastSummary.addCell(f1t2);tableLastSummary.addCell(f1t2m);
            ...
            PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3E3.getString(41)))/7)+" "+setF1T3E3.getString(43)+" "+setF1T3E3.getString(42),font));
            PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3",font2));
            PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T3E3.getString(41)))/7)+" "+setF2T3E3.getString(43)+" "+setF2T3E3.getString(42),font));
            ...
            PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T3E3.getString(41))/11)+" "+setF4T3E3.getString(43)+" "+setF4T3E3.getString(42),font));tableLastSummary.addCell(f1t3);tableLastSummary.addCell(f1t3m);
            ...
            dataSet.setValue(Float.parseFloat(setF1T1E3.getString(43)), "Marks", "F1T1");
            dataSet.setValue(Float.parseFloat(setF1T2E3.getString(43)), "Marks", "F1T2");
            dataSet.setValue(Float.parseFloat(setF1T3E3.getString(43)), "Marks", "F1T3");
            dataSet.setValue(Float.parseFloat(setF2T1E3.getString(43)), "Marks", "F2T1");
            dataSet.setValue(Float.parseFloat(setF2T2E3.getString(43)), "Marks", "F2T2");
            dataSet.setValue(Float.parseFloat(setF2T3E3.getString(43)), "Marks", "F2T3");
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell busD5 = new PdfPCell(new Paragraph(setE3.getString(35)+" "+setE3.getString(36),font2));
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell hisD5 = new PdfPCell(new Paragraph(setE3.getString(29)+" "+setE3.getString(30),font2));
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell geoD5 = new PdfPCell(new Paragraph(setE3.getString(26)+" "+setE3.getString(27),font2));
    ...
    document.add((new Paragraph(" ")));
            ...
            PdfPCell phyD5 = new PdfPCell(new Paragraph(setE3.getString(23)+" "+setE3.getString(24),font2));
    ...
    document.add((new Paragraph(" ")));
           ...
           Font font2 = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD);
            ...
            PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3E3.getString(41)))/7)+" "+setF1T3E3.getString(43)+" "+setF1T3E3.getString(42)));
            PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3"));
            PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T3E3.getString(41)))/7)+" "+setF2T3E3.getString(43)+" "+setF2T3E3.getString(42)));
            PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3"));
            PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T3E3.getString(41))/11)+" "+setF3T3E3.getString(43)+" "+setF3T3E3.getString(42),font));
            PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3"));
            PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T3E3.getString(41))/11)+" "+setF4T3E3.getString(43)+" "+setF4T3E3.getString(42),font));
    ...
    document.add((new Paragraph(" ")));
           ...
           Font font2 = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD);
            ...
            PdfPCell f1t1 = new PdfPCell(new Paragraph("F1T1",font2));
            PdfPCell f1t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T1E3.getString(41)))/11)+" "+setF1T1E3.getString(43)+" "+setF1T1E3.getString(42),font));
            PdfPCell f2t1 = new PdfPCell(new Paragraph("F2T1",font2));
            PdfPCell f2t1m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T1E3.getString(42)))/11)+" "+setF2T1E3.getString(43)+" "+setF2T1E3.getString(42),font));
            PdfPCell f3t1 = new PdfPCell(new Paragraph("F3T1",font2));
            ...
            PdfPCell f1t2 = new PdfPCell(new Paragraph("F1T2",font2));
            PdfPCell f1t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T2E3.getString(41)))/11)+" "+setF1T2E3.getString(43)+" "+setF1T2E3.getString(42),font));
            PdfPCell f2t2 = new PdfPCell(new Paragraph("F2T2",font2));
            PdfPCell f2t2m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T2E3.getString(41)))/11)+" "+setF2T2E3.getString(43)+" "+setF2T2E3.getString(42),font));
            PdfPCell f3t2 = new PdfPCell(new Paragraph("F3T2",font2));
            ...
            PdfPCell f1t3 = new PdfPCell(new Paragraph("F1T3",font2));
            PdfPCell f1t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF1T3E3.getString(41)))/11)+" "+setF1T3E3.getString(43)+" "+setF1T3E3.getString(42),font));
            PdfPCell f2t3 = new PdfPCell(new Paragraph("F2T3",font2));
            PdfPCell f2t3m = new PdfPCell(new Paragraph(String.valueOf((Integer.parseInt(setF2T3E3.getString(41)))/11)+" "+setF2T3E3.getString(43)+" "+setF2T3E3.getString(42),font));
            PdfPCell f3t3 = new PdfPCell(new Paragraph("F3T3",font2));
            PdfPCell f3t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF3T3E3.getString(41))/11)+" "+setF3T3E3.getString(43)+" "+setF3T3E3.getString(42),font));
            PdfPCell f4t3 = new PdfPCell(new Paragraph("F4T3",font2));
            PdfPCell f4t3m = new PdfPCell(new Paragraph(String.valueOf(Integer.parseInt(setF4T3E3.getString(41))/11)+" "+setF4T3E3.getString(43)+" "+setF4T3E3.getString(42),font));
